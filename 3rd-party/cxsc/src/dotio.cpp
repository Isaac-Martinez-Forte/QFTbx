...
std::string & operator <<(std::string & s,const dotprecision &a) noexcept
{
...
std::ostream & operator <<(std::ostream & s,const dotprecision &a) noexcept
{
   string str="";
   str << a;
   s << str;
...
std::string & operator >>(std::string & s,dotprecision &a) noexcept
{
   rndtype rnd;
   a_intg rndfl;
...
void operator >>(const std::string &s,dotprecision &a) noexcept
{
   string s2(s);
   s2 >> a;
}
void operator >>(const char *s,dotprecision &a) noexcept
{
   string s2(s);
   s2 >> a;
}

std::istream & operator >>(std::istream & s,dotprecision &a) noexcept
{
   char c;
   string d="";
