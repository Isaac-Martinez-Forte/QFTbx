...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        BenchmarkGolden{"Acc90Mc2", "acc90.qft", qftbx::mc2,
                        1000.0, 500.005, 0.01},
        //Example 2 with its tracking and stability bounds, read
        //conservatively off the boundary columns (both nodes bracketing a
        //phase). NT, NK and MC1 land within 0.3 % of the optimum of the
        //structure by brute force, 568.911; before the conservative reading
        //they returned 556.94-556.96, points that exceeded the stability
        //bound at w = 100 by 0.05 dB. MC (thesis) and MC2 terminate on a
        //wider box and sit higher (see the header).
        BenchmarkGolden{"Ex2NT", "qft_toolbox_ex2.qft", qftbx::nt,
                        567.2976504, 1.810519104, 140.0232483},
        BenchmarkGolden{"Ex2NK", "qft_toolbox_ex2.qft", qftbx::nk,
                        567.4241360, 1.834639752, 140.0842828},
        BenchmarkGolden{"Ex2Mc1", "qft_toolbox_ex2.qft", qftbx::mc1,
                        567.4219156, 1.834828800, 140.0842828},
        BenchmarkGolden{"Ex2McThesis", "qft_toolbox_ex2.qft", qftbx::mc_thesis,
                        579.4719402, 3.183796387, 144.5398047},
        //MC2 with the exact best gain (T3) and the gain contractor on the
        //terminal box: 0.05 dB under MC (thesis) at the same zero and pole,
        //the width in gain the corner used to inherit from the box.
        BenchmarkGolden{"Ex2Mc2", "qft_toolbox_ex2.qft", qftbx::mc2,
                        576.2405541, 3.183796387, 144.5398047}),
