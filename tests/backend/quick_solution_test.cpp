/**
 * @file
 * @brief The Quick Solution cuts against the paper's worked example.
 *
 * The gain, zero and pole cuts of algorithm NK are checked against the worked
 * example of Nataraj and Kubal (Int. J. Robust Nonlinear Control 17, 2007,
 * sec. 3.3.1): the DC motor at omega = 0.1 rad/s with |Bi|min = 37.2342 dB and
 * nominal plant 1/(s(s+1)) reduces to k' = 439429.20, z1' = 0.7146, p1' =
 * 4692.15 and p2' = 885.58, to the 0.1 % the paper's rounding allows. The phase
 * cuts of algorithm MC (Martínez-Forte and Cervera, Int. J. Robust Nonlinear
 * Control 31, 2021, QS2 stage 2) are checked as properties: every configuration
 * on the removed side of a cut stays in the forbidden phase strip, and just past
 * it the corner closest to allowed leaves it.
 */
