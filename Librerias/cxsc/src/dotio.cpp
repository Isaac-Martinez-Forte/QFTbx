...
std::string & operator <<(std::string & s,const dotprecision &a) noexcept(false)
{
...
std::ostream & operator <<(std::ostream & s,const dotprecision &a) noexcept(false)
{
   string str="";
   str << a;
   s << str;
...
std::string & operator >>(std::string & s,dotprecision &a) noexcept(false)
{
   rndtype rnd;
   a_intg rndfl;
...
void operator >>(const std::string &s,dotprecision &a) noexcept(false)
{
   string s2(s);
   s2 >> a;
}
void operator >>(const char *s,dotprecision &a) noexcept(false)
{
   string s2(s);
   s2 >> a;
}

std::istream & operator >>(std::istream & s,dotprecision &a) noexcept(false)
{
   char c;
   string d="";
