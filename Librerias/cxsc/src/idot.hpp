...
//      explicit inline idotprecision(const double &a, const double &b) : inf(a), sup(b) { }
      ...
      //! Constructor of class idotprecision
      explicit        idotprecision(const l_real &) noexcept(false);     // In l_real.cpp
      //! Constructor of class idotprecision
      explicit        idotprecision(const l_real &,const l_real &); // in l_real.cpp
      //! Constructor of class idotprecision
      explicit        idotprecision(const l_interval &) noexcept(false); // In l_interval.cpp
      ...
      //! Implementation of standard assigning operator
             idotprecision& operator= (const l_interval &) noexcept(false); // in l_interv.cpp
      ...
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      friend inline idotprecision _idotprecision(const l_real &a) noexcept(false) { return idotprecision(a); }
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      ...
      friend std::istream& operator >> (std::istream& s, idotprecision& a)       noexcept(false);
      //! Implementation of standard output method
      friend std::ostream& operator << (std::ostream& s, const idotprecision& a) noexcept(false);
      //! Implementation of standard input method
      friend std::string&  operator >> (std::string&  s, idotprecision& a)       noexcept(false);
      //! Implementation of standard output method
      friend std::string&  operator << (std::string&  s, const idotprecision& a) noexcept(false);
      //! Implementation of standard input method
      friend void          operator >> (const std::string &s,idotprecision& a)   noexcept(false);
      //! Implementation of standard input method
      friend void          operator >> (const char *s       ,idotprecision& a)   noexcept(false);

      // ---- Standardfunkt ---- (arithmetische Operatoren)
      //! Implementation of standard algebraic negative sign operation
      friend     inline idotprecision operator -(const idotprecision &) noexcept(false);
      ...
      friend     inline idotprecision & operator -=(idotprecision &,const idotprecision &) noexcept(false);
      //! Implementation of standard algebraic addition and allocation operation
      friend     inline idotprecision & operator +=(idotprecision &,const interval &) noexcept(false);
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     inline idotprecision & operator -=(idotprecision &,const interval &) noexcept(false);
      //! Implementation of standard algebraic addition and allocation operation
      friend     inline idotprecision & operator +=(idotprecision &,const real &) noexcept(false);
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     inline idotprecision & operator -=(idotprecision &,const real &) noexcept(false);
      //! Implementation of standard algebraic addition and allocation operation
      friend            idotprecision & operator +=(idotprecision &,const l_real &) noexcept(false);
      //! Implementation of standard algebraic subtraction and allocation operation
      friend            idotprecision & operator -=(idotprecision &,const l_real &) noexcept(false);
      //! Implementation of standard algebraic addition and allocation operation
      friend     inline idotprecision & operator +=(idotprecision &,const l_interval &) noexcept(false);
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     inline idotprecision & operator -=(idotprecision &,const l_interval &) noexcept(false);
...
//      friend     inline idotprecision & operator &=(idotprecision & i,const long & l) noexcept(false) { return i&=_dotprecision(l); }
      ...
      friend inline bool operator ==(const idotprecision &,const idotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const idotprecision &,const idotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const dotprecision &,const idotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const dotprecision &,const idotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const idotprecision &,const dotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const idotprecision &,const dotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const real &,const idotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const real &,const idotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const idotprecision &,const real &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const idotprecision &,const real &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const interval &,const idotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const interval &,const idotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const idotprecision &,const interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const idotprecision &,const interval &) noexcept(false);
      ...
      friend inline bool operator  >(const dotprecision &,const idotprecision &) noexcept(false) { return false; }
      //! Implementation of standard less-or-equal-than operation
      friend inline bool operator <=(const dotprecision &,const idotprecision &) noexcept(false);
      //! Implementation of standard greater-or-equal-than operation
      friend inline bool operator >=(const dotprecision &,const idotprecision &) noexcept(false);
      ...
      //! Implementation of standard less-than operation
      friend inline bool operator  <(const idotprecision &,const dotprecision &) noexcept(false) { return false; }
      //! Implementation of standard more-than operation
      friend inline bool operator  >(const idotprecision &,const dotprecision &) noexcept(false);
      //! Implementation of standard less-or-equal-than operation
      friend inline bool operator <=(const idotprecision &,const dotprecision &) noexcept(false);
      ...
      friend inline bool operator  <(const real &,const idotprecision &) noexcept(false);
      //! Implementation of standard more-than operation
      friend inline bool operator  >(const real &,const idotprecision &) noexcept(false) { return false; }
      //! Implementation of standard less-or-equal-than operation
      friend inline bool operator <=(const real &,const idotprecision &) noexcept(false);
      //! Implementation of standard greater-or-equal-than operation
      friend inline bool operator >=(const real &,const idotprecision &) noexcept(false);
      ...
      //! Implementation of standard less-than operation
      friend inline bool operator  <(const idotprecision &,const real &) noexcept(false) { return false; }
      //! Implementation of standard more-than operation
      friend inline bool operator  >(const idotprecision &,const real &) noexcept(false);
      //! Implementation of standard less-or-equal-than operation
      friend inline bool operator <=(const idotprecision &,const real &) noexcept(false);
      ...
      friend inline bool operator !(const idotprecision&) noexcept(false);
//                         operator void *(void) noexcept(false) { return (void *)(!*this); }
      
      // ---- Funktionen    ----
      
      //! Returns the infimum of a dotprecison interval
      friend dotprecision & Inf(idotprecision& a)  noexcept(false) { return a.inf; }
      //! Returns the supremum of a dotprecison interval
      friend dotprecision & Sup(idotprecision& a)  noexcept(false) { return a.sup; }
      //! Returns the infimum of a dotprecison interval
      friend const dotprecision & Inf(const idotprecision& a)  noexcept(false) { return a.inf; }
      //! Returns the supremum of a dotprecison interval
      friend const dotprecision & Sup(const idotprecision& a)  noexcept(false) { return a.sup; }
      
      //! Returns the dotprecison interval with the new given infimum value
      friend inline idotprecision& SetInf (idotprecision &, const dotprecision &) noexcept(false);
      //! Returns the dotprecison interval with the new given supremum value
      friend inline idotprecision& SetSup (idotprecision &, const dotprecision &) noexcept(false);
      //! Returns the dotprecison interval with the new given infimum value
      friend inline idotprecision& SetInf (idotprecision &, const real &) noexcept(false);
      //! Returns the dotprecison interval with the new given supremum value
      friend inline idotprecision& SetSup (idotprecision &, const real &) noexcept(false);
      //! Returns the dotprecison interval with the unchecked new given infimum value
      friend inline idotprecision& UncheckedSetInf (idotprecision &, const dotprecision &) noexcept(false);
      //! Returns the dotprecison interval with the unchecked new given supremum value
      friend inline idotprecision& UncheckedSetSup (idotprecision &, const dotprecision &) noexcept(false);
      //! Returns the dotprecison interval with the unchecked new given infimum value
      friend inline idotprecision& UncheckedSetInf (idotprecision &, const real &) noexcept(false);
      //! Returns the dotprecison interval with the unchecked new given supremum value
      friend inline idotprecision& UncheckedSetSup (idotprecision &, const real &) noexcept(false);

      //! Returns if the dotprecision interval is empty
      friend inline bool IsEmpty (const idotprecision& a) noexcept(false);

      //! Returns the absolute value of a dotprecision interval
      friend inline idotprecision   abs  (const idotprecision& a) noexcept(false);
      //! Returns the middle of the dotprecision interval
      friend inline dotprecision    mid  (const idotprecision& a) noexcept(false);
      //! Returns the rounded diameter of the dotprecision interval
      friend inline dotprecision    diam (const idotprecision& a) noexcept(false);
      
      friend void rnd(const idotprecision &,interval &) noexcept(false);
      friend interval rnd(const idotprecision &) noexcept(false);
      
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend        void accumulate  (idotprecision&, const interval&, const interval&) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate  (idotprecision&, const interval&, const real&) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate  (idotprecision&, const real&, const interval&) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate  (idotprecision&, const real&, const real&) noexcept(false);
};
