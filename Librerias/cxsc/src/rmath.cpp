...
real expmx2(const real& x) noexcept(false)
...
real sqrt1px2(const real& x) noexcept(false)
...
// real sqrtp1m1(const real& x) noexcept(false);  Blomquist, 05.08.03
const real sqrtp1m1_s = 9007199254740984.0 / 1125899906842624.0;

real sqrtp1m1(const real& x) noexcept(false)
...
real sqrtx2y2(const real& x, const real& y) noexcept(false)
...
real acoshp1(const real& x) noexcept(false)
