...
INLINE cimatrix::cimatrix() noexcept(false):dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE cimatrix::cimatrix(const cinterval &r) noexcept(false):lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const real &r) noexcept(false):lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const complex &r) noexcept(false):lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const interval &r) noexcept(false):lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const rmatrix &rm) noexcept(false):lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE cimatrix::cimatrix(const cmatrix &rm) noexcept(false):lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE cimatrix::cimatrix(const imatrix &rm) noexcept(false):lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE cimatrix::cimatrix(const cimatrix &rm) noexcept(false):lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE civector::civector(const cimatrix_subv &v) noexcept(false):l(v.lb),u(v.ub),size(v.size)
{
...
INLINE cimatrix::cimatrix(const civector &v) noexcept(false):lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE cimatrix::cimatrix(const rvector &v) noexcept(false):lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const cvector &v) noexcept(false):lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const ivector &v) noexcept(false):lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const civector_slice &v) noexcept(false):lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
...
INLINE cimatrix::cimatrix(const rvector_slice &v) noexcept(false):lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE cimatrix::cimatrix(const ivector_slice &v) noexcept(false):lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE cimatrix::cimatrix(const cvector_slice &v) noexcept(false):lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE cimatrix::cimatrix(const cimatrix_slice &sl) noexcept(false):lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const rmatrix_slice &sl) noexcept(false):lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const cmatrix_slice &sl) noexcept(false):lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const imatrix_slice &sl) noexcept(false):lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cimatrix_subv &rv) noexcept(false) { return _mvmvassign(*this,rv); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cinterval &r) noexcept(false) { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const rmatrix_subv &rv) noexcept(false) { return _mvvassign(*this,rvector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const real &r) noexcept(false) { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cmatrix_subv &rv) noexcept(false) { return _mvvassign(*this,cvector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const complex &r) noexcept(false) { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const imatrix_subv &rv) noexcept(false) { return _mvvassign(*this,ivector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const interval &r) noexcept(false) { return _mvsassign(*this,r); }
	...
	INLINE cimatrix &cimatrix::operator =(const cinterval &r) noexcept(false) { return _msassign(*this,r); }
	INLINE cimatrix &cimatrix::operator =(const cimatrix &m) noexcept(false) { return _mmassign<cimatrix,cimatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const cimatrix_slice &ms) noexcept(false) { return _mmsassign<cimatrix,cimatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const civector &v) noexcept(false) { return _mvassign<cimatrix,civector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const civector_slice &v) noexcept(false) { return _mvassign<cimatrix,civector,cinterval>(*this,civector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const real &r) noexcept(false) { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const rmatrix &m) noexcept(false) { return _mmassign<cimatrix,rmatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const rmatrix_slice &ms) noexcept(false) { return _mmsassign<cimatrix,rmatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const rvector &v) noexcept(false) { return _mvassign<cimatrix,rvector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const rvector_slice &v) noexcept(false) { return _mvassign<cimatrix,rvector,cinterval>(*this,rvector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const complex &r) noexcept(false) { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const cmatrix &m) noexcept(false) { return _mmassign<cimatrix,cmatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const cmatrix_slice &ms) noexcept(false) { return _mmsassign<cimatrix,cmatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const cvector &v) noexcept(false) { return _mvassign<cimatrix,cvector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const cvector_slice &v) noexcept(false) { return _mvassign<cimatrix,cvector,cinterval>(*this,cvector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const interval &r) noexcept(false) { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const imatrix &m) noexcept(false) { return _mmassign<cimatrix,imatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const imatrix_slice &ms) noexcept(false) { return _mmsassign<cimatrix,imatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const ivector &v) noexcept(false) { return _mvassign<cimatrix,ivector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const ivector_slice &v) noexcept(false) { return _mvassign<cimatrix,ivector,cinterval>(*this,ivector(v)); }
	
	INLINE cimatrix::operator void*() noexcept(false) { return _mvoid(*this); }
	...
	INLINE cimatrix_slice &cimatrix_slice::operator =(const cinterval &r) noexcept(false) { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const real &r) noexcept(false) { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const complex &r) noexcept(false) { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const interval &r) noexcept(false) { return _mssassign(*this,r); }
	...
	INLINE cimatrix_slice::operator void*() noexcept(false) { return _msvoid(*this); }
	INLINE civector operator /(const cimatrix_subv &rv, const cinterval &s) noexcept(false) { return _mvsdiv<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cimatrix_subv &rv, const cinterval &s) noexcept(false) { return _mvsmult<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const cimatrix_subv &rv) noexcept(false) { return _mvsmult<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const cinterval &c) noexcept(false) { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const cinterval &c) noexcept(false) { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const cinterval &c) noexcept(false) { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const cinterval &c) noexcept(false) { return _mvsdivassign(*this,c); }
	INLINE ivector abs(const cimatrix_subv &mv) noexcept(false) { return _mvabs<cimatrix_subv,ivector>(mv); }
	INLINE cvector diam(const cimatrix_subv &mv) noexcept(false) { return _mvdiam<cimatrix_subv,cvector>(mv); }
	INLINE cvector mid(const cimatrix_subv &mv) noexcept(false) { return _mvmid<cimatrix_subv,cvector>(mv); }
	INLINE cvector Inf(const cimatrix_subv &mv) noexcept(false) { return _mvinf<cimatrix_subv,cvector>(mv); }
	INLINE cvector Sup(const cimatrix_subv &mv) noexcept(false) { return _mvsup<cimatrix_subv,cvector>(mv); }
	INLINE ivector Im(const cimatrix_subv &mv) noexcept(false) { return _mvim<cimatrix_subv,ivector>(mv); }
	INLINE ivector Re(const cimatrix_subv &mv) noexcept(false) { return _mvre<cimatrix_subv,ivector>(mv); }

	INLINE rmatrix InfRe(const cimatrix &m) noexcept(false)
	{
	...
	INLINE rmatrix InfRe(const cimatrix_slice &sl) noexcept(false)
	{
	...
	INLINE rmatrix SupRe(const cimatrix &m) noexcept(false)
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix SupRe(const cimatrix_slice &sl) noexcept(false)
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE rmatrix InfIm(const cimatrix &m) noexcept(false)
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix InfIm(const cimatrix_slice &sl) noexcept(false)
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE rmatrix SupIm(const cimatrix &m) noexcept(false)
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix SupIm(const cimatrix_slice &sl) noexcept(false)
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE cimatrix_subv &SetSup(cimatrix_subv &iv,const complex &r) noexcept(false) { return _mvssetsup(iv,r); }
	INLINE cimatrix_subv &SetInf(cimatrix_subv &iv,const complex &r) noexcept(false) { return _mvssetinf(iv,r); }
	INLINE cimatrix_subv &UncheckedSetSup(cimatrix_subv &iv,const complex &r) noexcept(false) { return _mvsusetsup(iv,r); }
	INLINE cimatrix_subv &SetUncheckedInf(cimatrix_subv &iv,const complex &r) noexcept(false) { return _mvsusetinf(iv,r); }
	INLINE cimatrix_subv &SetRe(cimatrix_subv &iv,const interval &r) noexcept(false) { return _mvssetre(iv,r); }
	INLINE cimatrix_subv &SetIm(cimatrix_subv &iv,const interval &r) noexcept(false) { return _mvssetim(iv,r); }
	INLINE civector &civector::operator =(const cimatrix_subv &mv) noexcept(false) { return _vmvassign<civector,cimatrix_subv,cinterval>(*this,mv); }
	INLINE civector_slice &civector_slice::operator =(const cimatrix_subv &mv) noexcept(false) { return _vsvassign(*this,civector(mv)); }
...
//  matrix x matrix
	...
	*/
	INLINE cimatrix _imatrix(const cimatrix &rm) noexcept(false) { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const civector &v)
	*/
	INLINE cimatrix _imatrix(const civector &v) noexcept(false) { return cimatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const civector_slice &v)
	*/
	INLINE cimatrix _imatrix(const civector_slice &v) noexcept(false) { return cimatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const cinterval &r)
	*/
	INLINE cimatrix _imatrix(const cinterval &r) noexcept(false) { return cimatrix(r); }
	...
	INLINE void Resize(cimatrix &A) noexcept(false) { _mresize(A);}
	...
	INLINE imatrix abs(const cimatrix &m) noexcept(false) { return _mabs<cimatrix,imatrix>(m); }
	INLINE imatrix abs(const cimatrix_slice &ms) noexcept(false) { return _msabs<cimatrix_slice,imatrix>(ms); }
	INLINE cmatrix diam(const cimatrix &m) noexcept(false) { return _mdiam<cimatrix,cmatrix>(m); }
	INLINE cmatrix diam(const cimatrix_slice &m) noexcept(false) { return _msdiam<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix mid(const cimatrix &m) noexcept(false) { return _mmid<cimatrix,cmatrix>(m); }
	INLINE cmatrix mid(const cimatrix_slice &m) noexcept(false) { return _msmid<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix Inf(const cimatrix &m) noexcept(false) { return _minf<cimatrix,cmatrix>(m); }
	INLINE cmatrix Sup(const cimatrix &m) noexcept(false) { return _msup<cimatrix,cmatrix>(m); }
	INLINE cmatrix Inf(const cimatrix_slice &m) noexcept(false) { return _msinf<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix Sup(const cimatrix_slice &m) noexcept(false) { return _mssup<cimatrix_slice,cmatrix>(m); }
	...
	INLINE imatrix Im(const cimatrix &m) noexcept(false) { return _mim<cimatrix,imatrix>(m); }
	INLINE imatrix Re(const cimatrix &m) noexcept(false) { return _mre<cimatrix,imatrix>(m); }
	INLINE imatrix Im(const cimatrix_slice &m) noexcept(false) { return _msim<cimatrix_slice,imatrix>(m); }
	INLINE imatrix Re(const cimatrix_slice &m) noexcept(false) { return _msre<cimatrix_slice,imatrix>(m); }
...
//	INLINE cinterval cinterval::_interval(const cimatrix &m) throw(ERROR_CIMATRIX_TYPE_CAST_OF_THICK_OBJ,ERROR_CIMATRIX_USE_OF_UNINITIALIZED_OBJ) { _smconstr(*this,m); return *this; }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const real &c) noexcept(false) { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const real &c) noexcept(false) { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const real &c) noexcept(false) { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const real &c) noexcept(false) { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const complex &c) noexcept(false) { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const complex &c) noexcept(false) { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const complex &c) noexcept(false) { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const complex &c) noexcept(false) { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const interval &c) noexcept(false) { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const interval &c) noexcept(false) { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const interval &c) noexcept(false) { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const interval &c) noexcept(false) { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix operator *(const cinterval &c, const cimatrix &m) noexcept(false) { return _smmult<cinterval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const cimatrix_slice &ms) noexcept(false) { return _smsmult<cinterval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const cinterval &c) noexcept(false) { return _smmult<cinterval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const cinterval &c) noexcept(false) { return _smsmult<cinterval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const cinterval &c) noexcept(false) { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cimatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cinterval &c) noexcept(false) { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const cinterval &c) noexcept(false) { return _msdiv<cimatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const cinterval &c) noexcept(false) { return _mssdiv<cimatrix_slice,cinterval,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const cinterval &c) noexcept(false) { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const cinterval &c) noexcept(false) { return _mssdivassign(*this,c); }
	
	INLINE cimatrix operator *(const real &c, const cimatrix &m) noexcept(false) { return _smmult<real,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const real &c, const cimatrix_slice &ms) noexcept(false) { return _smsmult<real,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const real &c) noexcept(false) { return _smmult<real,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const real &c) noexcept(false) { return _smsmult<real,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const real &c) noexcept(false) { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const real &c) noexcept(false) { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const real &c) noexcept(false) { return _msdiv<cimatrix,real,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const real &c) noexcept(false) { return _mssdiv<cimatrix_slice,real,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const real &c) noexcept(false) { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const real &c) noexcept(false) { return _mssdivassign(*this,c); }

	INLINE cimatrix operator *(const complex &c, const cimatrix &m) noexcept(false) { return _smmult<complex,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const complex &c, const cimatrix_slice &ms) noexcept(false) { return _smsmult<complex,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const complex &c) noexcept(false) { return _smmult<complex,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const complex &c) noexcept(false) { return _smsmult<complex,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const complex &c) noexcept(false) { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const complex &c) noexcept(false) { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const complex &c) noexcept(false) { return _msdiv<cimatrix,complex,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const complex &c) noexcept(false) { return _mssdiv<cimatrix_slice,complex,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const complex &c) noexcept(false) { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const complex &c) noexcept(false) { return _mssdivassign(*this,c); }

	INLINE cimatrix operator *(const interval &c, const cimatrix &m) noexcept(false) { return _smmult<interval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const interval &c, const cimatrix_slice &ms) noexcept(false) { return _smsmult<interval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const interval &c) noexcept(false) { return _smmult<interval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const interval &c) noexcept(false) { return _smsmult<interval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const interval &c) noexcept(false) { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const imatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const interval &c) noexcept(false) { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const interval &c) noexcept(false) { return _msdiv<cimatrix,interval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const interval &c) noexcept(false) { return _mssdiv<cimatrix_slice,interval,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const interval &c) noexcept(false) { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const interval &c) noexcept(false) { return _mssdivassign(*this,c); }
...
//	INLINE cinterval cinterval::_interval(const cimatrix &m) throw(ERROR_CIMATRIX_TYPE_CAST_OF_THICK_OBJ,ERROR_CIMATRIX_USE_OF_UNINITIALIZED_OBJ) { _smconstr(*this,m); return *this; }
	...
	INLINE cimatrix operator *(const cinterval &c, const rmatrix &m) noexcept(false) { return _smmult<cinterval,rmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const rmatrix_slice &ms) noexcept(false) { return _smsmult<cinterval,rmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const rmatrix &m,const cinterval &c) noexcept(false) { return _smmult<cinterval,rmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const rmatrix_slice &ms,const cinterval &c) noexcept(false) { return _smsmult<cinterval,rmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const rmatrix &m,const cinterval &c) noexcept(false) { return _msdiv<rmatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const rmatrix_slice &ms, const cinterval &c) noexcept(false) { return _mssdiv<rmatrix_slice,cinterval,cimatrix>(ms,c); }

	INLINE cimatrix operator *(const cinterval &c, const cmatrix &m) noexcept(false) { return _smmult<cinterval,cmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const cmatrix_slice &ms) noexcept(false) { return _smsmult<cinterval,cmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cmatrix &m,const cinterval &c) noexcept(false) { return _smmult<cinterval,cmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cmatrix_slice &ms,const cinterval &c) noexcept(false) { return _smsmult<cinterval,cmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const cmatrix &m,const cinterval &c) noexcept(false) { return _msdiv<cmatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cmatrix_slice &ms, const cinterval &c) noexcept(false) { return _mssdiv<cmatrix_slice,cinterval,cimatrix>(ms,c); }

	INLINE cimatrix operator *(const cinterval &c, const imatrix &m) noexcept(false) { return _smmult<cinterval,imatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const imatrix_slice &ms) noexcept(false) { return _smsmult<cinterval,imatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const imatrix &m,const cinterval &c) noexcept(false) { return _smmult<cinterval,imatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const imatrix_slice &ms,const cinterval &c) noexcept(false) { return _smsmult<cinterval,imatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const imatrix &m,const cinterval &c) noexcept(false) { return _msdiv<imatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const imatrix_slice &ms, const cinterval &c) noexcept(false) { return _mssdiv<imatrix_slice,cinterval,cimatrix>(ms,c); }
	...
	INLINE const cimatrix &operator +(const cimatrix &m) noexcept(false) { return m; }
	INLINE cimatrix operator +(const cimatrix_slice &m) noexcept(false) { return cimatrix(m); }
	...
	INLINE cimatrix operator -(const cimatrix &m) noexcept(false) { return _mminus(m); }
	INLINE cimatrix operator -(const cimatrix_slice &m) noexcept(false) { return _msminus<cimatrix_slice,cimatrix>(m); }
	INLINE cimatrix operator -(const cimatrix &m1,const cimatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
//------------- complex x complex ------------------------
	...
	INLINE bool operator ==(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmeq(m1,m2); }
	INLINE bool operator !=(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmneq(m1,m2); }
	INLINE bool operator <(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmless(m1,m2); }
	INLINE bool operator <=(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmleq(m1,m2); }
	INLINE bool operator >(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmless(m2,m1); }
	INLINE bool operator >=(const cimatrix &m1,const cimatrix &m2) noexcept(false) { return _mmleq(m2,m1); }
	INLINE bool operator ==(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _mmseq(m1,ms); }
	INLINE bool operator !=(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _mmsneq(m1,ms); }
	INLINE bool operator <(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _mmsless(m1,ms); }
	INLINE bool operator <=(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _mmsleq(m1,ms); }
	INLINE bool operator >(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _msmless(ms,m1); }
	INLINE bool operator >=(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false) { return _msmleq(ms,m1); }
	INLINE bool operator ==(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmseq(m1,m2); }
	INLINE bool operator !=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmsneq(m1,m2); }
	INLINE bool operator <(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmsless(m1,m2); }
	INLINE bool operator <=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmsleq(m1,m2); }
	INLINE bool operator >(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmsless(m2,m1); }
	INLINE bool operator >=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false) { return _msmsleq(m2,m1); }
	INLINE bool operator !(const cimatrix &ms) noexcept(false) { return _mnot(ms); }
	INLINE bool operator !(const cimatrix_slice &ms) noexcept(false) { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix &r) noexcept(false) { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix_slice &r) noexcept(false) { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cimatrix &r) noexcept(false) { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cimatrix_slice &r) noexcept(false) { return _msin(s,r); }
