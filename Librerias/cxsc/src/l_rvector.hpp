...
template <class MV,class V> friend  MV &_mvvsectassign(MV &v,const V &rv)
	...
	INLINE l_rvector () noexcept(false);
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const int &i) noexcept(false);
#ifdef OLD_CXSC
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const class index &i) noexcept(false); // for backwards compatibility
#endif
	//! Constructor of class l_rvector
...
#endif
	//! Constructor of class l_rvector
	INLINE l_rvector(const l_rmatrix_subv &) noexcept(false);
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const l_real &) noexcept(false);
	//! Constructor of class l_rvector
...
#endif
	//! Constructor of class l_rvector
	INLINE l_rvector(const l_rvector_slice &rs) noexcept(false);
	//! Constructor of class l_rvector
	INLINE l_rvector(const l_rvector &v) noexcept(false);
	// Real
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const real &) noexcept(false);
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const rvector_slice &rs) noexcept(false);
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const rvector &v) noexcept(false);
	//! Constructor of class l_rvector
...
#endif
	//! Constructor of class l_rvector
	explicit INLINE l_rvector(const rmatrix_subv &) noexcept(false);
	
	// l_real
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const l_rvector &rv) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const l_rvector_slice &sl) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const l_real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const l_rmatrix_subv &) noexcept(false);
	// Real
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const rvector &rv) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const rvector_slice &sl) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector &operator =(const rmatrix_subv &) noexcept(false);
	...
	friend INLINE int Lb(const l_rvector &rv) noexcept(false) { return rv.l; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const l_rvector &rv) noexcept(false) { return rv.u; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const l_rvector &rv) noexcept(false) { return rv.size; }
	//! Sets the lower bound of the vector
	friend INLINE l_rvector & SetLb(l_rvector &rv, const int &l) noexcept(false) { rv.l=l; rv.u=l+rv.size-1; return rv;}
	//! Sets the upper bound of the vector
	friend INLINE l_rvector & SetUb(l_rvector &rv, const int &u) noexcept(false) { rv.u=u; rv.l=u-rv.size+1; return rv;}
	...
	INLINE l_rvector & operator ()() noexcept(false) { return *this; }
...
// l_real / l_real
 ...
 template <class VS1,class VS2> friend 	 VS1 &_vsvssectassign(VS1 &sl1, const VS2 &sl2)
	...
	explicit INLINE l_rvector_slice(l_rvector &a, const int &lb, const int &ub) noexcept(false):dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	//! Constructor of class l_rvector_slice
	explicit INLINE l_rvector_slice(l_rvector_slice &a, const int &lb, const int &ub) noexcept(false):dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	public:
	//! Constructor of class l_rvector_slice
	INLINE l_rvector_slice(const l_rvector_slice &a) noexcept(false):dat(a.dat),l(a.l),u(a.u),size(a.size),start(a.start),end(a.end) { }
	public:
	// l_real
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector_slice & operator =(const l_real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector_slice &operator =(const l_rmatrix_subv &) noexcept(false);
	// Real
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector_slice & operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_rvector_slice &operator =(const rmatrix_subv &mv) noexcept(false);
...
#endif
	//! Returns the lower bound of the vector
	friend INLINE int Lb(const l_rvector_slice &sl) noexcept(false) { return sl.start; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const l_rvector_slice &sl) noexcept(false) { return sl.end; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const l_rvector_slice &sl) noexcept(false) { return sl.end-sl.start+1; }
	//! Operator for accessing the single elements of the vector
	INLINE l_real & operator [](const int &i) const
#if(CXSC_INDEX_CHECK)
	noexcept(false);
...
#endif
	//! Operator for accessing the whole vector
	INLINE l_rvector_slice & operator ()() noexcept(false) { return *this; }
	//! Operator for accessing a part of the vector
	INLINE l_rvector_slice operator ()(const int &i)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
...
//======================== Vector Functions =============================
	...
	INLINE l_rvector _l_rvector(const l_real &r) noexcept(false);
...
//	INLINE l_rvector _l_rvector(const l_rmatrix_slice &sl) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_rvector _l_rvector(const real &r) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_rvector _l_rvector(const rvector_slice &rs) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_rvector _l_rvector(const rvector &rs) noexcept(false);
...
//	INLINE l_rvector _l_rvector(const rmatrix_slice &sl) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_rvector _l_rvector(const rmatrix_subv &rs) noexcept(false);

	//! Resizes the vector
	INLINE void Resize(l_rvector &rv) noexcept(false);
	//! Resizes the vector
	...
	INLINE l_rvector abs(const l_rvector &rv) noexcept(false);
	//! Returns the absolute value of the vector
	INLINE l_rvector abs(const l_rvector_slice &sl) noexcept(false);
	//! Implementation of standard negation operation
	INLINE bool operator !(const l_rvector &rv) noexcept(false);
	//! Implementation of standard negation operation
	INLINE bool operator !(const l_rvector_slice &sl) noexcept(false);
...
//----------------------------- l_real ---------------------------
	...
	INLINE l_rvector operator *(const l_rvector &rv, const l_real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_rvector_slice &sl, const l_real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_real &s, const l_rvector &rv) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_real &s, const l_rvector_slice &sl) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_rvector &operator *=(l_rvector &rv,const l_real &r) noexcept(false);
...
//---------------------------- Real --------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_rvector &rv, const real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_rvector_slice &sl, const real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const real &s, const l_rvector &rv) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const real &s, const l_rvector_slice &sl) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_rvector &operator *=(l_rvector &rv,const real &r) noexcept(false);
	...
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const rvector &rv, const l_real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const rvector_slice &sl, const l_real &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_real &s, const rvector &rv) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_rvector operator *(const l_real &s, const rvector_slice &sl) noexcept(false);
...
//======================= Vector / Vector ===============================
	...
	INLINE std::ostream &operator <<(std::ostream &s, const l_rvector &rv) noexcept(false);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &o, const l_rvector_slice &sl) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, l_rvector &rv) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, l_rvector_slice &rv) noexcept(false);
...
//----------------------- l_real / l_real ---------------------------
	...
	INLINE const l_rvector &operator +(const l_rvector &rv) noexcept(false);
	//! Implementation of positive sign operation
	INLINE l_rvector operator +(const l_rvector_slice &sl) noexcept(false);
	...
	INLINE bool operator ==(const l_rvector &rv1, const l_rvector &rv2) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_rvector_slice &sl1, const l_rvector_slice &sl2) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_rvector_slice &sl, const l_rvector &rv) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_rvector &rv, const l_rvector_slice &sl) noexcept(false);
