...
template <class MV1,class MV2> friend  MV1 &_mvmvassign(MV1 &v,const MV2 &rv)
	...
	noexcept(false);
#endif
template <class MV,class S> friend  MV &_mvsassign(MV &v,const  S &r) noexcept(false);
...
template <class MV,class V> friend  V _mvsup(const MV &mv) noexcept(false);
 ...
 template <class MV,class S> friend 	 MV &_mvssetinf(MV &mv, const S &s) noexcept(false);
 template <class MV,class S> friend 	 MV &_mvssetsup(MV &mv, const S &s) noexcept(false);
 template <class MV,class S> friend 	 MV &_mvsusetinf(MV &mv, const S &s) noexcept(false);
 template <class MV,class S> friend 	 MV &_mvsusetsup(MV &mv, const S &s) noexcept(false);
 template <class MV,class S> friend 	 MV &_mvssetim(MV &mv, const S &s) noexcept(false);
 template <class MV,class S> friend 	 MV &_mvssetre(MV &mv, const S &s) noexcept(false);
...
template <class MV,class S> friend  MV &_mvsmultassign(MV &v,const S &r) noexcept(false);
template <class MV, class S> friend  MV &_mvsplusassign(MV &v,const S &r) noexcept(false);
template <class MV,class S> friend  MV &_mvsminusassign(MV &v,const S &r) noexcept(false);
template <class MV,class S> friend  MV &_mvsdivassign(MV &v,const S &r) noexcept(false);
...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE cimatrix_subv (cinterval *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept(false):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class cimatrix_subv
	INLINE cimatrix_subv(const cimatrix_subv &v) noexcept(false):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:
	...
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cimatrix_subv &rv) noexcept(false);
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cinterval &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const rmatrix_subv &rv) noexcept(false);

	// complex
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const complex &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const cmatrix_subv &rv) noexcept(false);

	// interval
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const imatrix_subv &rv) noexcept(false);

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const cimatrix_subv &rv) noexcept(false) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const cimatrix_subv &rv) noexcept(false) { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const cimatrix_subv &rv) noexcept(false) { return rv.size; }
	...
	INLINE cimatrix_subv &operator ()() noexcept(false) { return *this; }
	...
	INLINE cimatrix_subv &operator *=(const cinterval &c) noexcept(false);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const real &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const real &c) noexcept(false);
	...
	// complex
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const complex &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const complex &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const complex &c) noexcept(false);
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const interval &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const interval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const interval &c) noexcept(false);
...
template <class V,class M,class S> friend  void _vmconstr(V &v,const M &m)
	...
	noexcept(false);
#endif
 template <class M1,class M2,class S> friend 	 M1 &_mmassign(M1 &m1,const M2 &m,S ms) noexcept(false);
 template <class M,class MS2,class S> friend 	 M &_mmsassign(M &m,const MS2 &ms) noexcept(false);
 template <class MS,class M> friend 	 MS &_msmassign(MS &ms,const M &m)
	...
	noexcept(false);
#endif
 template <class M,class S> friend 	 M &_msassign(M &m,const S &r) noexcept(false);
...
template <class M,class V,class S> friend  M &_mvassign(M &m,const V &v) noexcept(false);
 ...
 template <class M> friend 	 M &_msetub(M &m, const int &i,const int &j)
	...
	noexcept(false);
#endif
 template <class M> friend 	 void _mresize(M &A) noexcept(false);
 ...
 template <class M,class S> friend 	 void _mresize(M &A,const int &m1, const int &m2,const int &n1,const int &n2)
	...
	noexcept(false);
#endif
 template <class M,class E> friend 	 E _mabs(const M &m) noexcept(false);
 template <class M,class E> friend 	 E _mdiam(const M &m) noexcept(false);
 template <class M,class E> friend 	 E _mmid(const M &m) noexcept(false);
 template <class M,class E> friend 	 E _mre(const M &m) noexcept(false);
 template <class M,class E> friend 	 E _mim(const M &m) noexcept(false);
	friend INLINE rmatrix SupRe(const cimatrix &v) noexcept(false);
	friend INLINE rmatrix SupIm(const cimatrix &v) noexcept(false);
	friend INLINE rmatrix InfRe(const cimatrix &v) noexcept(false);
	friend INLINE rmatrix InfIm(const cimatrix &v) noexcept(false);
 ...
 template <class M1,class MS2> friend 	 M1 &_mmssetim(M1 &m1,const MS2 &ms2)
	...
	noexcept(false);
#endif
 template <class M,class E> friend 	 E _minf(const M &m) noexcept(false);
 template <class M,class E> friend 	 E _msup(const M &m) noexcept(false);
 ...
 template <class M,class MS,class E> friend 	 E _mmsplus(const M &m,const MS &ms)
	...
	noexcept(false);
#endif
 template <class M> friend 	 M _mminus(const M &m) noexcept(false);
 template <class MS,class E> friend 	 E _msminus(const MS &ms) noexcept(false);
...
#endif
	//-------- matrix-scalar -----------------
 template <class S,class M,class E> friend 	 E _smmult(const S &c, const M &m) noexcept(false);
 template <class M,class S> friend 	 M &_msmultassign(M &m,const S &c) noexcept(false);
 template <class S,class MS,class E> friend 	 E _smsmult(const S &c, const MS &ms) noexcept(false);
 template <class M,class S,class E> friend 	 E _msdiv(const M &m,const S &c) noexcept(false);
 template <class M,class S> friend 	 M &_msdivassign(M &m,const S &c) noexcept(false);
 template <class MS,class S,class E> friend 	 E _mssdiv(const MS &ms, const S &c) noexcept(false);
	//-------- matrix-vector ---------------------
 ...
 template <class M> friend 	 void *_mvoid(const M &m) noexcept(false);
 template <class M> friend 	 bool _mnot(const M &m) noexcept(false);
 template <class MS> friend 	 void *_msvoid(const MS &ms) noexcept(false);
 template <class MS> friend 	 bool _msnot(const MS &ms) noexcept(false);
 template <class M1,class M2> friend 	 bool _mmeq(const M1 &m1,const M2 &m2) noexcept(false);
 template <class M1,class M2> friend 	 bool _mmneq(const M1 &m1,const M2 &m2) noexcept(false);
 template <class M1,class M2> friend 	 bool _mmless(const M1 &m1,const M2 &m2) noexcept(false);
 template <class M1,class M2> friend 	 bool _mmleq(const M1 &m1,const M2 &m2) noexcept(false);
 template <class M,class MS> friend 	 bool _mmseq(const M &m1,const MS &ms) noexcept(false);
 template <class M,class MS> friend 	 bool _mmsneq(const M &m1,const MS &ms) noexcept(false);
 template <class M,class MS> friend 	 bool _mmsless(const M &m1,const MS &ms) noexcept(false);
 template <class M,class MS> friend 	 bool _mmsleq(const M &m1,const MS &ms) noexcept(false);
 template <class MS,class M> friend 	 bool _msmless(const MS &ms,const M &m1) noexcept(false);
 template <class MS,class M> friend 	 bool _msmleq(const MS &ms,const M &m1) noexcept(false);
 template <class M> friend 	std::ostream &_mout(std::ostream &s,const M &r) noexcept(false);
 template <class M> friend 	std::istream &_min(std::istream &s,M &r) noexcept(false);
...
// cinterval
	...
	INLINE cimatrix(const cimatrix &rm) noexcept(false);
	//! Constructor of class cimatrix
	INLINE cimatrix(const cimatrix_slice &rm) noexcept(false);
	//! Constructor of class cimatrix
	INLINE cimatrix(const scimatrix &rm);
	//! Constructor of class cimatrix
	INLINE cimatrix(const scimatrix_slice &rm);
	//! Constructor of class cimatrix
	INLINE cimatrix() noexcept(false);
	//! Constructor of class cimatrix
...
#endif
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector &v) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector_slice &v) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cinterval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cinterval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector_slice &v) noexcept(false);
//  real
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const real &r) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix_slice &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector &v) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector_slice &v) noexcept(false);

//  complex
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const complex &r) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix_slice &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector &v) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const complex &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector_slice &v) noexcept(false);

//  interval
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const interval &r) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix_slice &rm) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector &v) noexcept(false);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector_slice &v) noexcept(false);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~cimatrix() noexcept(false) { delete [] dat; }
	...
	INLINE cimatrix &operator ()() noexcept(false) { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
...
#endif
 template <class M,class MS2,class S> friend 	 M &_mmsassign(M &m,const MS2 &ms) noexcept(false);
 template <class MS,class S> friend 	 MS &_mssassign(MS &ms,const S &r) noexcept(false);
 ...
 template <class MS> friend 	 int _msub(const MS &ms, const int &i)
	...
	noexcept(false);
#endif
 template <class MS,class E> friend 	 E _msabs(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _msinf(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _mssup(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _msdiam(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _msmid(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _msre(const MS &ms) noexcept(false);
 template <class MS,class E> friend 	 E _msim(const MS &ms) noexcept(false);
	friend INLINE rmatrix SupRe(const cimatrix_slice &v) noexcept(false);
	friend INLINE rmatrix SupIm(const cimatrix_slice &v) noexcept(false);
	friend INLINE rmatrix InfRe(const cimatrix_slice &v) noexcept(false);
	friend INLINE rmatrix InfIm(const cimatrix_slice &v) noexcept(false);
 ...
 template <class V,class MS,class S> friend 	 V &_vmscimultassign(V &v,const MS &ms)
	...
	//--------- matrix-scalar --------------
 template <class S,class MS,class E> friend 	 E _smsmult(const S &c, const MS &ms) noexcept(false);
 template <class MS,class S> friend 	 MS &_mssmultassign(MS &ms,const S &c) noexcept(false);
 template <class MS,class S,class E> friend 	 E _mssdiv(const MS &ms, const S &c) noexcept(false);
 template <class MS,class S> friend 	 MS &_mssdivassign(MS &ms,const S &c) noexcept(false);
 ...
 template <class MS,class M> friend 	 bool _msmless(const MS &ms,const M &m1) noexcept(false);
 template <class MS,class M> friend 	 bool _msmleq(const MS &ms,const M &m1) noexcept(false);
 template <class MS1,class MS2> friend 	 bool _msmseq(const MS1 &ms1,const MS2 &ms2) noexcept(false);
 template <class MS1,class MS2> friend 	 bool _msmsneq(const MS1 &ms1,const MS2 &ms2) noexcept(false);
 template <class MS1,class MS2> friend 	 bool _msmsless(const MS1 &ms1,const MS2 &ms2) noexcept(false);
 template <class MS1,class MS2> friend 	 bool _msmsleq(const MS1 &ms1,const MS2 &ms2) noexcept(false);
 template <class MS> friend 	std::ostream &_msout(std::ostream &s,const MS &r) noexcept(false);
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r) noexcept(false);
	...
	explicit INLINE cimatrix_slice(cimatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class cimatrix_slice
	explicit INLINE cimatrix_slice(cimatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class cimatrix_slice
	INLINE cimatrix_slice(const cimatrix_slice &ms) noexcept(false):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept(false);
#endif
	friend INLINE cimatrix::cimatrix(const cimatrix_slice &) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const cinterval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const complex &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	//! Operator for accessing the whole matrix
	INLINE cimatrix_slice &operator ()() noexcept(false) { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE cimatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const cinterval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const cinterval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const cinterval &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const real &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const complex &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const complex &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const complex &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const interval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const interval &c) noexcept(false);
...
//=======================Vector / Scalar =========================
	...
	INLINE civector operator /(const cimatrix_subv &rv, const cinterval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE civector operator *(const cimatrix_subv &rv, const cinterval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE civector operator *(const cinterval &s, const cimatrix_subv &rv) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE ivector abs(const cimatrix_subv &mv) noexcept(false);
	//! Returns the diameter of the matrix
	INLINE cvector diam(const cimatrix_subv &mv) noexcept(false);
	//! Returns the middle of the matrix
	INLINE cvector mid(const cimatrix_subv &mv) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE cvector Inf(const cimatrix_subv &mv) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE cvector Sup(const cimatrix_subv &mv) noexcept(false);
	//! Returns the imaginary part of the matrix
	INLINE ivector Im(const cimatrix_subv &mv) noexcept(false);
	//! Returns the real part of the matrix
	INLINE ivector Re(const cimatrix_subv &mv) noexcept(false);
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix &v) noexcept(false);
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix &v) noexcept(false);
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix &v) noexcept(false);
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix &v) noexcept(false);
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix_slice &v) noexcept(false);
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix_slice &v) noexcept(false);
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix_slice &v) noexcept(false);
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix_slice &v) noexcept(false);
	...
	//! Returns the matrix with the new given supremum value
	INLINE cimatrix_subv &SetSup(cimatrix_subv &iv,const complex &r) noexcept(false);
	//! Returns the matrix with the new given infimum value
	INLINE cimatrix_subv &SetInf(cimatrix_subv &iv,const complex &r) noexcept(false);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE cimatrix_subv &UncheckedSetSup(cimatrix_subv &iv,const complex &r) noexcept(false);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE cimatrix_subv &SetUncheckedInf(cimatrix_subv &iv,const complex &r) noexcept(false);
	//! Sets componentwise the real parts of the matrix
	INLINE cimatrix_subv &SetRe(cimatrix_subv &iv,const interval &r) noexcept(false);
	//! Sets componentwise the imaginary parts of the matrix
	INLINE cimatrix_subv &SetIm(cimatrix_subv &iv,const interval &r) noexcept(false);
...
//===================== Matrix Functions =============================
	...
	INLINE cimatrix _imatrix(const cimatrix &rm) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector_slice &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const cinterval &r) noexcept(false);
...
#endif
	//! Resizes the matrix
	INLINE void Resize(cimatrix &A) noexcept(false);
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix &m) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix_slice &ms) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix &m) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix_slice &m) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix &m) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix_slice &m) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix &m) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix_slice &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix_slice &m) noexcept(false);
	//! Returns the matrix with the new given infimum value
	...
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix &m) noexcept(false);
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix &m) noexcept(false);
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix_slice &m) noexcept(false);
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix_slice &m) noexcept(false);
	//! Sets componentwise the imaginary parts of the matrix
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const cinterval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const cinterval &c) noexcept(false);
...
//------------ real - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const real &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const real &c) noexcept(false);
...
//----------------- rmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix_slice &ms,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix_slice &ms, const cinterval &c) noexcept(false);
...
//------------ complex - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const complex &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const complex &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const complex &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const complex &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const complex &c) noexcept(false);
...
//----------------- cmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix_slice &ms,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix_slice &ms, const cinterval &c) noexcept(false);
...
//------------ interval - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const interval &c) noexcept(false);
...
//----------------- imatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix_slice &ms,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix &m,const cinterval &c) noexcept(false);
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix_slice &ms, const cinterval &c) noexcept(false);
...
//================ Matrix / Matrix ============================
	...
	INLINE const cimatrix &operator +(const cimatrix &m1) noexcept(false);
	//! Implementation of positive sign operation
	INLINE cimatrix operator +(const cimatrix_slice &ms) noexcept(false);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const cimatrix &m1,const cimatrix &m2) noexcept(false);
	...
	INLINE bool operator >=(const cimatrix &m1,const cimatrix &m2) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix &m1,const cimatrix_slice &ms) noexcept(false);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept(false);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const cimatrix &ms) noexcept(false);
	//! Implementation of standard negation operation
	INLINE bool operator !(const cimatrix_slice &ms) noexcept(false);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix &r) noexcept(false);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix_slice &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix_slice &r) noexcept(false);
