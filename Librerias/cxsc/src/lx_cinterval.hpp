...
public:
    ...
    inline lx_cinterval(void)  noexcept(false) { }
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const lx_interval &, const lx_interval &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const l_interval &, const l_interval &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const interval &,   const interval &)   noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const l_real &,     const l_real &)     noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const lx_real &,     const lx_real &)     noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const real &,       const real &)       noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const l_cinterval &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const cinterval &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const complex &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const l_complex &) noexcept(false);
    //! Constructor of class lx_cinterval 
    inline lx_cinterval(const lx_complex &) noexcept(false);
    //! Constructor of class lx_cinterval
	...
	noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const real&, const l_interval&, const real&, const l_interval&) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const real&, const l_interval&) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const real&, const l_interval&, const lx_interval&) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const lx_interval&, const real&, const l_interval&) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const real&, const string&, const real&, const string&) noexcept(false);
    //! Constructor of class lx_cinterval
    explicit inline lx_cinterval(const lx_interval &) noexcept(false);
    //! Constructor of class lx_cinterval
    explicit inline lx_cinterval(const l_interval &) noexcept(false);
    //! Constructor of class lx_cinterval
    inline lx_cinterval(const interval &) noexcept(false);
    //! Constructor of class lx_cinterval
    explicit inline lx_cinterval(const lx_real &) noexcept(false);
    //! Constructor of class lx_cinterval
    explicit inline lx_cinterval(const l_real &) noexcept(false);
    //! Constructor of class lx_cinterval
    explicit inline lx_cinterval(const real &) noexcept(false);
    //! Constructor of class lx_cinterval

    // ------------- Assignments ---------------------------------------------

    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const lx_cinterval & ) noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const l_cinterval & ) noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const cinterval & )   noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const lx_interval & )  noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const l_interval & )  noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const interval & )    noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const lx_real & )      noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const l_real & )      noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const real & )        noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const lx_complex & )   noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const l_complex & )   noexcept(false);
    //! Implementation of standard assigning operator
    inline lx_cinterval & operator = (const complex & )     noexcept(false);
...
friend inline lx_cinterval operator -(const lx_cinterval &) noexcept(false);
...
friend inline bool operator ! (const lx_cinterval&) noexcept(false);
...
friend inline bool operator != (const lx_cinterval &, const lx_cinterval &) 
    ...
    friend inline lx_interval Re(const lx_cinterval &) noexcept(false);
    //! Returns the imaginary interval of the complex interval
    friend inline lx_interval Im(const lx_cinterval &) noexcept(false);

    //! Returns the infinum of a complex interval
    friend inline lx_complex Inf(const lx_cinterval &) noexcept(false);
    //! Returns the supremum of a complex interval
    friend inline lx_complex Sup(const lx_cinterval &) noexcept(false);
    ...
    friend inline lx_real InfRe(const lx_cinterval&) noexcept(false); 
    //! Returns the infimum of the imaginary interval of the complex interval
    friend inline lx_real InfIm(const lx_cinterval&) noexcept(false);
    //! Returns the supremum of the real interval of the complex interval
    friend inline lx_real SupRe(const lx_cinterval&) noexcept(false);
    //! Returns the supremum of the imaginary interval of the complex interval
    friend inline lx_real SupIm(const lx_cinterval&) noexcept(false);

    //! Returns the rounded middle of the complex interval
    friend inline lx_complex mid(const lx_cinterval &) noexcept(false);
    //! Returns the rounded diameter of the complex interval
    friend inline lx_complex diam(const lx_cinterval &) noexcept(false);
    //! Returns the exponent of the real part of the complex interval
    friend inline real expo_Re(const lx_cinterval &) noexcept(false);
    //! Returns the exponent of the imaginary part of the complex interval
    friend inline real expo_Im(const lx_cinterval &) noexcept(false);
    //! Returns the li_part of the real part of the complex interval
    friend inline l_interval li_part_Re(const lx_cinterval &) noexcept(false);
    //! Returns the li_part of the imaginary part of the complex interval
    friend inline l_interval li_part_Im(const lx_cinterval &) noexcept(false);
    //! Returns the absolute value of a complex interval
    friend inline lx_interval abs(const lx_cinterval &) noexcept(false);
    //! matches the precision of a complex interval to the actual stagprec value
    friend inline lx_cinterval adjust(const lx_cinterval &) noexcept(false);
    //! Returns the conjugated complex interval 
    friend inline lx_cinterval conj(const lx_cinterval &) noexcept(false);
    //! Multiplication of an interval with \f$ 2^n \f$
    friend inline void times2pown(lx_cinterval& , const real&) noexcept(false);
    //! Returns 1 if the argument is an empty interval
    friend inline bool IsEmpty(const lx_cinterval&) noexcept(false);
...
// ---------------------------------------------------------------------------
    ...
    //! Implementation of standard negation operation
    inline bool operator ! (const lx_cinterval&) noexcept(false);
    //! Implementation of standard equality operation
...
// -------------- friend Functions declared in lx_cinterval ------------------
    ...
    inline lx_complex Inf(const lx_cinterval &) noexcept(false);
    //! Returns the supremum of the real and imaginary part
    inline lx_complex Sup(const lx_cinterval &) noexcept(false);
    //! Returns the real part of the complex interval

    inline lx_interval Re(const lx_cinterval &) noexcept(false);
    //! Returns the imaginary part of the complex interval
    inline lx_interval Im(const lx_cinterval &) noexcept(false);
    ...
    //! Returns the infimum of the real interval of the complex interval
    inline lx_real InfRe(const lx_cinterval&) noexcept(false); 
    //! Returns the infimum of the imaginary interval of the complex interval
    inline lx_real InfIm(const lx_cinterval&) noexcept(false);
    //! Returns the supremum of the real interval of the complex interval
    inline lx_real SupRe(const lx_cinterval&) noexcept(false);
    //! Returns the supremum of the imaginary interval of the complex interval
    inline lx_real SupIm(const lx_cinterval&) noexcept(false);

    //! Returns the complex middle of the complex interval
    inline lx_complex mid(const lx_cinterval &) noexcept(false);
    //! Returns the complex valued diameter of the complex interval
    inline lx_complex diam(const lx_cinterval &) noexcept(false);
    ...
    inline l_interval li_part_Re(const lx_cinterval &) noexcept(false);
    //! Returns the l_interval of the imaginary part of the complex interval
    inline l_interval li_part_Im(const lx_cinterval &) noexcept(false);
    //! Sets the precision of a specific long datatype value
    inline lx_cinterval adjust(const lx_cinterval &) noexcept(false);
    //! Returns the conjugated complex interval
    inline lx_cinterval conj(const lx_cinterval &) noexcept(false);
    //! Multiplication of interval with \f$ 2^n \f$
    inline void times2pown(lx_cinterval& , const real&) noexcept(false);
    //! Returns the absolute value of the complex interval
    inline lx_interval abs(const lx_cinterval &) noexcept(false); 
    ...
    //! Returns 1 if the argument is an empty interval
    inline bool IsEmpty(const lx_cinterval&) noexcept(false);
...
// ***************************************************************************
	...
	noexcept(false);
    //! Implementation of standard algebraic division and allocation operation
    inline lx_cinterval & operator /=(lx_cinterval &, const l_real &) noexcept(false);
    //! Implementation of standard algebraic division and allocation operation
    inline lx_cinterval & operator /=(lx_cinterval &, const lx_real &) noexcept(false);
    //! Implementation of standard algebraic division and allocation operation
    inline lx_cinterval & operator /=(lx_cinterval &, const real &) noexcept(false);
    //! Implementation of standard algebraic division and allocation operation
...
// ------------------------- Set Operators ------------------------------
    ...
    inline bool operator > (const lx_cinterval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >= (const lx_cinterval &, const lx_cinterval &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const l_cinterval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation 
    inline bool operator  >(const l_cinterval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const l_cinterval &, const lx_cinterval &) noexcept(false);
    ...
    inline bool operator >=(const l_cinterval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_cinterval &, const l_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const l_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_cinterval &, const l_cinterval &) noexcept(false);
    ...
    //! Implementation of standard less-than operation
    inline bool operator  <(const cinterval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard greater-than operation
    inline bool operator  >(const cinterval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const cinterval &, const lx_cinterval &) noexcept(false);
    ...
    inline bool operator >=(const cinterval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_cinterval &, const cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_cinterval &, const cinterval &) noexcept(false);
    ...
    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation 
    inline bool operator  >(const lx_interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_interval &, const lx_cinterval &) noexcept(false);
    ...
    inline bool operator >=(const lx_interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-than operation 
    inline bool operator  <(const lx_cinterval &, const lx_interval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const lx_interval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_cinterval &, const lx_interval &) noexcept(false);
    ...
    //! Implementation of standard less-than operation
    inline bool operator  <(const l_interval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard greater-than operation
    inline bool operator  >(const l_interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const l_interval &, const lx_cinterval &) noexcept(false);
    ...
    inline bool operator >=(const l_interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-than operation 
    inline bool operator  <(const lx_cinterval &, const l_interval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const l_interval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_cinterval &, const l_interval &) noexcept(false);
    ...
    //! Implementation of standard less-than operation
    inline bool operator  <(const interval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard greater-than operation
    inline bool operator  >(const interval &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const interval &, const lx_cinterval &) noexcept(false);
    ...
    inline bool operator >=(const interval &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_cinterval &, const interval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const interval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_cinterval &, const interval &) noexcept(false);
    ...
    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation 
    inline bool operator <=(const lx_real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const lx_real &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const lx_real &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const l_real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation 
    inline bool operator <=(const l_real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const l_real &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const l_real &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation 
    inline bool operator <=(const real &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const real &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const real &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const complex &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard less-or-equal-than operation 
    inline bool operator <=(const complex &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const complex &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const complex &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const l_complex &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const l_complex &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const l_complex &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const l_complex &) noexcept(false);

    //! Implementation of standard less-than operation
    inline bool operator  <(const lx_complex &, const lx_cinterval &) noexcept(false); 
    //! Implementation of standard less-or-equal-than operation
    inline bool operator <=(const lx_complex &, const lx_cinterval &) noexcept(false);
    //! Implementation of standard greater-than operation
    inline bool operator  >(const lx_cinterval &, const lx_complex &) noexcept(false);
    //! Implementation of standard greater-or-equal-than operation
    inline bool operator >=(const lx_cinterval &, const lx_complex &) noexcept(false);
...
// ------------------------ Input --------------------------------------
    ...
    std::string & operator >> (std::string&, lx_cinterval&) noexcept(false);
    //! Implementation of standard input method
    void operator >> (const std::string&, lx_cinterval&) noexcept(false);
    //! Implementation of standard input method
    void operator >> (const char *s, lx_cinterval&) noexcept(false);
    //! Implementation of standard input method
    std::istream & operator >> (std::istream&, lx_cinterval&) noexcept(false);
...
// ---------------------------------------------------------------------------
    ...
    //! Calculates \f$ [z]^2  \f$
	 lx_cinterval sqr(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \sqrt{[z]}  \f$
	 lx_cinterval sqrt(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \sqrt[n]{[z]} \f$
	 lx_cinterval sqrt(const lx_cinterval& ,int) noexcept(false); 
    //! Calculates \f$ \exp([z]) \f$
	 lx_cinterval exp(const lx_cinterval&) noexcept(false);
	 //! Calculates \f$ 2^{[z]} \f$
	 lx_cinterval exp2(const lx_cinterval&) noexcept(false);
	 //! Calculates \f$ 10^{[z]} \f$
	 lx_cinterval exp10(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \sin([z]) \f$
	 lx_cinterval sin(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \cos([z]) \f$
	 lx_cinterval cos(const lx_cinterval&) noexcept(false);

    //! Calculates \f$ \cosh([z]) \f$
	 lx_cinterval cosh(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \sinh([z]) \f$
	 lx_cinterval sinh(const lx_cinterval&) noexcept(false);

    //! Calculates \f$ \mbox{Arg}([z]) \f$
	 lx_interval Arg(const lx_cinterval&) noexcept(false);
    //! Calculates \f$ \mbox{arg}([z]) \f$
	 lx_interval arg(const lx_cinterval&) noexcept(false);

    //! Calculates \f$ \ln([z]) \f$
	 lx_cinterval Ln(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \ln([z]) \f$
	 lx_cinterval ln(const lx_cinterval& ) noexcept(false);
	 
    //! Calculates \f$ \mbox{log2}([z]) \f$
	 lx_cinterval log2(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \mbox{log10}([z]) \f$
	 lx_cinterval log10(const lx_cinterval& ) noexcept(false);

    //! Calculates \f$ [z]^n \f$
	 lx_cinterval power_fast( const lx_cinterval&, const real& ) noexcept(false);
    //! Calculates \f$ [z]^n \f$
	 lx_cinterval power( const lx_cinterval&, const real& ) noexcept(false);
    //! Calculates \f$ [z]^{[p]} \f$
	 lx_cinterval pow( const lx_cinterval& , const lx_interval& ) noexcept(false);
    //! Calculates \f$ [z]^{[w]} \f$
	 lx_cinterval pow( const lx_cinterval& , const lx_cinterval& ) noexcept(false);

    //! Calculates \f$ \tan([z]) \f$
	 lx_cinterval tan (const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \cot([z]) \f$
	 lx_cinterval cot (const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \tanh([z]) \f$
	 lx_cinterval tanh(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \coth([z]) \f$
	 lx_cinterval coth(const lx_cinterval& ) noexcept(false);

    //! Calculates \f$ \arcsin([z]) \f$
	 lx_cinterval asin(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \arccos([z]) \f$
	 lx_cinterval acos(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \arctan([z]) \f$
	 lx_cinterval atan(const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \mbox{arccot}([z]) \f$
	 lx_cinterval acot(const lx_cinterval& ) noexcept(false);

    //! Calculates \f$ \mbox{arcsinh}([z]) \f$
	 lx_cinterval asinh( const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \mbox{arccosh}([z]) \f$
	 lx_cinterval acosh( const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \mbox{arctanh}([z]) \f$
	 lx_cinterval atanh( const lx_cinterval& ) noexcept(false);
    //! Calculates \f$ \mbox{arccoth}([z]) \f$
	 lx_cinterval acoth( const lx_cinterval& ) noexcept(false);
	 
    //! Calculates \f$ \mbox{sqrt}(1+[z]^2) \f$
	 lx_cinterval sqrt1px2(const lx_cinterval& z) noexcept(false);
    //! Calculates \f$ \mbox{sqrt}(1-[z]^2) \f$	 
	 lx_cinterval sqrt1mx2(const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{sqrt}([z]^2-1) \f$
	 lx_cinterval sqrtx2m1(const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{sqrt}([z]+1)-1 \f$
	 lx_cinterval sqrtp1m1(const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{exp}([z])-1 \f$
	 lx_cinterval expm1(const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{ln}(1+[z]) \f$	 
	 lx_cinterval lnp1(const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{sqrt}([z]) \f$ and returns all possible solutions
	 std::list<lx_cinterval> sqrt_all( const lx_cinterval& z) noexcept(false);
	 //! Calculates \f$ \mbox{sqrt}[n][z] \f$ and returns all possible solutions
	 std::list<lx_cinterval> sqrt_all( const lx_cinterval& z, int n ) noexcept(false);
	 //! Calculates \f$ [z]^{[y]} \f$ and returns all possible solutions
	 std::list<lx_cinterval> pow_all( const lx_cinterval& z, const lx_interval& p ) noexcept(false);
}  // end namespace cxsc
