...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE l_imatrix_subv (l_interval *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept(false):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
	public:
	//! Constructor of class l_imatrix_subv
	INLINE l_imatrix_subv(const l_imatrix_subv &v) noexcept(false):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:

	//---------------------- Standardfunktionen ------------------------

	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_imatrix_subv &rv) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const rmatrix_subv &rv) noexcept(false);

	// l_real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_rmatrix_subv &rv) noexcept(false);

	// interval
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const imatrix_subv &rv) noexcept(false);

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const l_imatrix_subv &rv) noexcept(false) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const l_imatrix_subv &rv) noexcept(false) { return rv.ub; }
	...
	INLINE l_imatrix_subv &operator ()() noexcept(false) { return *this; }
	...
	INLINE l_imatrix_subv &operator *=(const l_interval &c) noexcept(false);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const real &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const real &c) noexcept(false);
	...
	// l_real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const l_real &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const l_real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const l_real &c) noexcept(false);
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const interval &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const interval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const interval &c) noexcept(false);
...
// l_interval
	...
	INLINE l_imatrix(const l_imatrix &rm) noexcept(false);
	//! Constructor of class l_imatrix
	INLINE l_imatrix(const l_imatrix_slice &rm) noexcept(false);
	//! Constructor of class l_imatrix
	INLINE l_imatrix() noexcept(false);
	//! Constructor of class l_imatrix
...
#endif
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector &v) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector_slice &v) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector_slice &v) noexcept(false);
//  real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const real &r) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix_slice &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector &v) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector_slice &v) noexcept(false);

//  l_real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_real &r) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix_slice &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector &v) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_real &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector_slice &v) noexcept(false);

//  interval
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const interval &r) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix_slice &rm) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector &v) noexcept(false);
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector_slice &v) noexcept(false);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~l_imatrix() noexcept(false) { delete [] dat; }
	...
	INLINE l_imatrix &operator ()() noexcept(false) { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r) noexcept(false);
	...
	explicit INLINE l_imatrix_slice(l_imatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class l_imatrix_slice
	explicit INLINE l_imatrix_slice(l_imatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class l_imatrix_slice
	INLINE l_imatrix_slice(const l_imatrix_slice &ms) noexcept(false):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept(false);
#endif
	friend INLINE l_imatrix::l_imatrix(const l_imatrix_slice &) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_real &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Operator for accessing the whole matrix
	INLINE l_imatrix_slice &operator ()() noexcept(false) { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE l_imatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_interval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_interval &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const real &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_real &c) noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const interval &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const interval &c) noexcept(false);
...
//=======================Vector / Scalar =========================
	...
	INLINE l_ivector operator /(const l_imatrix_subv &rv, const l_interval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_imatrix_subv &rv, const l_interval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_interval &s, const l_imatrix_subv &rv) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE l_ivector abs(const l_imatrix_subv &mv) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE l_rvector diam(const l_imatrix_subv &mv) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE l_rvector mid(const l_imatrix_subv &mv) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE l_rvector Inf(const l_imatrix_subv &mv) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE l_rvector Sup(const l_imatrix_subv &mv) noexcept(false);
	...
	//! Returns the matrix with the new given supremum value
	INLINE l_imatrix_subv &SetSup(l_imatrix_subv &iv,const l_real &r) noexcept(false);
	//! Returns the matrix with the new given infimum value
	INLINE l_imatrix_subv &SetInf(l_imatrix_subv &iv,const l_real &r) noexcept(false);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE l_imatrix_subv &UncheckedSetSup(l_imatrix_subv &iv,const l_real &r) noexcept(false);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE l_imatrix_subv &SetUncheckedInf(l_imatrix_subv &iv,const l_real &r) noexcept(false);
...
//===================== Matrix Functions =============================
	...
	INLINE l_imatrix _imatrix(const l_imatrix &rm) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector_slice &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_interval &r) noexcept(false);
...
#endif
	//! Resizes the matrix
	INLINE void Resize(l_imatrix &A) noexcept(false);
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix &m) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix_slice &ms) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix &m) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix_slice &m) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix &m) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix_slice &m) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix &m) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix_slice &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix_slice &m) noexcept(false);
	//! Returns the matrix with the new given infimum value
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_interval &c) noexcept(false);
...
//------------ real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const real &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const real &c) noexcept(false);
...
//----------------- rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix_slice &ms,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix_slice &ms, const l_interval &c) noexcept(false);
...
//------------ l_real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_real &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_real &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_real &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_real &c) noexcept(false);
...
//----------------- l_rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix_slice &ms,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix_slice &ms, const l_interval &c) noexcept(false);
...
//------------ interval - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const interval &c) noexcept(false);
...
//----------------- imatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix_slice &ms,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix &m,const l_interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix_slice &ms, const l_interval &c) noexcept(false);
...
//================ Matrix / Matrix ============================
	...
	INLINE const l_imatrix &operator +(const l_imatrix &m1) noexcept(false);
	//! Implementation of positive sign operation
	INLINE l_imatrix operator +(const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix &m2) noexcept(false);
	...
	INLINE bool operator >=(const l_imatrix &m1,const l_imatrix &m2) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept(false);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept(false);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const l_imatrix &ms) noexcept(false);
	//! Implementation of standard negation operation
	INLINE bool operator !(const l_imatrix_slice &ms) noexcept(false);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix &r) noexcept(false);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix_slice &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix_slice &r) noexcept(false);
