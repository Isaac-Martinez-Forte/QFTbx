...
class l_interval
{
   ...
   public:
      ...
      //! Constructor of class l_interval
      explicit inline l_interval(const real &) noexcept(false);
      //! Constructor of class l_interval
      explicit inline l_interval(const l_real &) noexcept(false);
      ...
      inline l_interval & operator= (const real & a)    noexcept(false);
      //! Implementation of standard assigning operator
      inline l_interval & operator= (const l_real &a)  noexcept(false);
      //! Implementation of standard assigning operator
      inline l_interval & operator= (const interval & a)noexcept(false);
      //! Implementation of standard assigning operator
             l_interval & operator= (const l_interval &a)noexcept(false);
      //! Implementation of standard assigning operator
             l_interval& operator = (const lx_interval&) noexcept(false);
#if (CXSC_INDEX_CHECK)
      //! Implementation of standard assigning operator
      ...
      // ---- Typwandlungen ----
      //! Constructor of class l_interval
      explicit inline l_interval(const interval &) noexcept(false);

      friend        interval::interval(const l_interval &) noexcept(false);
      friend        interval _interval(const l_interval &) noexcept(false);
      friend interval & interval::operator =(const l_interval &) noexcept(false);
            
      friend inline interval _interval(const real &, const l_real &) noexcept(false); // Sollte in l_real!!!
      friend inline interval _interval(const l_real &, const real &) noexcept(false);
      friend inline interval _interval(const l_real &) noexcept(false);
      friend        interval _unchecked_interval(const l_real &, const l_real &) noexcept(false);

//      friend inline l_interval _l_interval(const real & a) noexcept(false) { return l_interval(a); }
//      friend inline l_interval _l_interval(const real & a, const real & b) noexcept(false) { return l_interval(a,b); }
//      friend inline l_interval _l_interval(const l_real & a) noexcept(false) { return l_interval(a); }
...
//      friend inline l_interval _l_interval(const interval & a) noexcept(false) { return l_interval(a); }
//      friend inline l_interval _l_interval(const dotprecision & a) noexcept(false) { return l_interval(a); }
//      friend inline l_interval _l_interval(const dotprecision & a,const dotprecision & b) noexcept(false) { return l_interval(a,b); }
//      friend inline l_interval _l_interval(const idotprecision & a) noexcept(false) { return l_interval(a); }

      friend        l_interval _unchecked_l_interval(const l_real &, const l_real &) noexcept(false);      
      friend        idotprecision _idotprecision(const l_interval &) noexcept(false);
      friend        idotprecision::idotprecision(const l_interval &) noexcept(false);
      friend idotprecision & idotprecision::operator =(const l_interval &) noexcept(false);
      
      // ---- Ausgabefunkt. ---------------------------------------
      //! Implementation of standard input method
      friend std::istream& operator >> (std::istream& s, l_interval & a)       noexcept(false);
      //! Implementation of standard output method
      friend std::ostream& operator << (std::ostream& s, const l_interval & a) noexcept(false);
      //! Implementation of standard input method
      friend std::string & operator >> (std::string&  s, l_interval & a)       noexcept(false);
      //! Implementation of standard output method
      friend std::string & operator << (std::string&  s, const l_interval & a) noexcept(false);
      //! Implementation of standard input method
      friend void          operator >> (const std::string& s,l_interval &a)   noexcept(false);
      //! Implementation of standard input method
      friend void          operator >> (const char *       s,l_interval &a)   noexcept(false);      

      // ---- Standardfunkt ---- (arithmetische Operatoren)
      // LI
      //! Implementation of standard algebraic negative sign operation
      friend        l_interval operator -(const l_interval &) noexcept(false);
      //! Implementation of standard algebraic positive sign operation
      friend inline l_interval operator +(const l_interval &) noexcept(false);
      ...
      friend inline l_interval operator |(const l_interval &,const l_real &) noexcept(false);
      //! Returns the convex hull of the arguments
      friend inline l_interval operator |(const l_real &,const l_real &)     noexcept(false);
      //! Returns the intersection of the arguments
      friend inline l_interval operator &(const l_real &,const l_interval &) noexcept(false);
      //! Returns the intersection of the arguments
      friend inline l_interval operator &(const l_interval &,const l_real &) noexcept(false);
      ...
      friend        bool operator !(const l_interval &) noexcept(false);
//                         operator void *(void) noexcept(false);

      //! Implementation of standard equality operation
      friend        bool operator ==(const l_interval &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const l_interval &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_real &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_real &,const l_interval &) noexcept(false);
      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_interval &,const l_real &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const l_real &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const interval &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const interval &,const l_interval &) noexcept(false);
      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_interval &,const interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const interval &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const real &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const real &,const l_interval &) noexcept(false);
      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_interval &,const real &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const real &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const idotprecision &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const idotprecision &,const l_interval &) noexcept(false);
      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_interval &,const idotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const idotprecision &) noexcept(false);

      //! Implementation of standard equality operation
      friend inline bool operator ==(const dotprecision &,const l_interval &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const dotprecision &,const l_interval &) noexcept(false);
      //! Implementation of standard equality operation
      friend inline bool operator ==(const l_interval &,const dotprecision &) noexcept(false);
      //! Implementation of standard negated equality operation
      friend inline bool operator !=(const l_interval &,const dotprecision &) noexcept(false);
...
//      friend inline l_interval_Inf Inf (l_interval &)  noexcept(false);
//      friend inline l_interval_Sup Sup (l_interval &)  noexcept(false);
      //! Returns the infimum of an interval
      friend inline l_real         Inf (const l_interval &) noexcept(false);
      //! Returns the supremum of an interval
      friend inline l_real         Sup (const l_interval &) noexcept(false);
      ...
      friend inline int StagPrec(const l_interval &) noexcept(false);
      ...
      friend inline l_interval  adjust (const l_interval &) noexcept(false);         

      //! Returns the interval with the unchecked new given infimum value
      friend inline l_interval & UncheckedSetInf (l_interval & a, const l_real & b) noexcept(false);
      //! Returns the interval with the unchecked new given supremum value
      friend inline l_interval & UncheckedSetSup (l_interval & a, const l_real & b) noexcept(false);
      //! Returns the interval with the unchecked new given infimum value
      friend inline l_interval & UncheckedSetInf (l_interval & a, const real & b) noexcept(false);
      //! Returns the interval with the unchecked new given supremum value
      friend inline l_interval & UncheckedSetSup (l_interval & a, const real & b) noexcept(false);
      
      //! Allocates the convex hull of the arguments to the first argument
      friend void ConvexHull(const l_interval &, const l_interval &, l_interval &, l_interval &) noexcept(false);
      //! Allocates the intersection of the arguments to the first argument
      ...
      friend inline l_interval abs  (const l_interval & a) noexcept(false);
      //! Returns the rounded middle of the interval
      friend        l_real     mid  (const l_interval & a) noexcept(false);
      //! Returns the rounded diameter of the interval
      friend inline l_real     diam (const l_interval & a) noexcept(false);
      ...
      friend l_interval atan(const l_interval &) noexcept(false);   // ATan(x)
      //! Calculates \f$ \mbox{arccot}([x]) \f$
      friend l_interval acot(const l_interval &) noexcept(false);   // ACot(x)
      ...
      friend l_interval tanh(const l_interval &) noexcept(false);   // Tanh(x)
      //! Calculates \f$ \coth([x]) \f$
      friend l_interval coth(const l_interval &) noexcept(false);   // Coth(x)           
      ...
      friend l_interval acosh(const l_interval &) noexcept(false);  // ACosh(x)
      ...
      friend l_interval Ln2_l_interval() noexcept(false);     // ln(2)
      //! Enclosure-Interval for \f$ \ln 10 \f$
      friend l_interval Ln10_l_interval() noexcept(false);  // ln(10)
      //! Enclosure-Interval for \f$ \frac{1}{\ln 10} \f$
      friend l_interval Ln10r_l_interval() noexcept(false); // 1/ln(10)
      //! Enclosure-Interval for \f$ \frac{\pi}{4} \f$
      friend l_interval Pid4_l_interval() noexcept(false);  // Pi/4
      //! Enclosure-Interval for \f$ \sqrt{2} \f$
      friend l_interval Sqrt2_l_interval() noexcept(false); // sqrt(2)
      //! Enclosure-Interval for \f$ \sqrt{5} \f$
      friend l_interval Sqrt5_l_interval() noexcept(false); // sqrt(5)
      //! Enclosure-Interval for \f$ \sqrt{7} \f$
      friend l_interval Sqrt7_l_interval() noexcept(false); // sqrt(7)
      ...
      friend l_interval Ln2r_l_interval() noexcept(false);     // 1/ln(2)
      //! Enclosure-Interval for \f$ \pi \f$
      friend l_interval Pi_l_interval() noexcept(false);       // Pi
      //! Enclosure-Interval for \f$ \frac{\pi}{2} \f$
      friend l_interval Pid2_l_interval() noexcept(false);     // Pi/2
      //! Enclosure-Interval for \f$ 2\pi \f$
      friend l_interval Pi2_l_interval() noexcept(false);      // 2*Pi
      //! Enclosure-Interval for \f$ \frac{\pi}{3} \f$
      friend l_interval Pid3_l_interval() noexcept(false);     // Pi/3
      //! Enclosure-Interval for \f$ \frac{1}{\pi} \f$
      friend l_interval Pir_l_interval() noexcept(false);      // 1/Pi
      //! Enclosure-Interval for \f$ \frac{1}{2\pi} \f$
      friend l_interval Pi2r_l_interval() noexcept(false);     // 1/(2*Pi)
      //! Enclosure-Interval for \f$ \sqrt{\pi} \f$
      friend l_interval SqrtPi_l_interval() noexcept(false);   // sqrt(Pi)
      //! Enclosure-Interval for \f$ \sqrt{2\pi} \f$
      friend l_interval Sqrt2Pi_l_interval() noexcept(false);  // sqrt(2*Pi)
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{\pi}} \f$
      friend l_interval SqrtPir_l_interval() noexcept(false);  // 1/sqrt(Pi)
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{2\pi}} \f$
      friend l_interval Sqrt2Pir_l_interval() noexcept(false); // 1/sqrt(2*Pi)
      //! Enclosure-Interval for \f$ 2^\pi \f$
      friend l_interval Pip2_l_interval() noexcept(false);     // Pi^2
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{2}} \f$
      friend l_interval Sqrt2r_l_interval() noexcept(false);   // 1/sqrt(2)
      //! Enclosure-Interval for \f$ \sqrt{3} \f$
      friend l_interval Sqrt3_l_interval() noexcept(false);    // sqrt(3)
      //! Enclosure-Interval for \f$ \frac{\sqrt{3}}{2} \f$
      friend l_interval Sqrt3d2_l_interval() noexcept(false);  // sqrt(3)/2
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{3}} \f$
      friend l_interval Sqrt3r_l_interval() noexcept(false);   // 1/sqrt(3)
      //! Enclosure-Interval for \f$ \ln \pi \f$
      friend l_interval LnPi_l_interval() noexcept(false);     // ln(Pi)
      //! Enclosure-Interval for \f$ \ln 2\pi \f$
      friend l_interval Ln2Pi_l_interval() noexcept(false);    // ln(2*Pi)
      //! Enclosure-Interval for \f$ e \f$
      friend l_interval E_l_interval() noexcept(false);        // e = exp(1)
      //! Enclosure-Interval for \f$ \frac{1}{e} \f$
      friend l_interval Er_l_interval() noexcept(false);       // 1/e
      //! Enclosure-Interval for \f$ e^2 \f$
      friend l_interval Ep2_l_interval() noexcept(false);      // e^2
      //! Enclosure-Interval for \f$ \frac{1}{e^2} \f$
      friend l_interval Ep2r_l_interval() noexcept(false);     // 1/e^2
      //! Enclosure-Interval for \f$ e^\pi \f$
      friend l_interval EpPi_l_interval() noexcept(false);     // e^Pi
      //! Enclosure-Interval for \f$ e^{2\pi} \f$
      friend l_interval Ep2Pi_l_interval() noexcept(false);    // e^(2*Pi)
      //! Enclosure-Interval for \f$ e^{\frac{\pi}{2}} \f$
      friend l_interval EpPid2_l_interval() noexcept(false);   // e^(Pi/2)
      //! Enclosure-Interval for \f$ e^{\frac{\pi}{4}} \f$
      friend l_interval EpPid4_l_interval() noexcept(false);   // e^(Pi/4)
      //! Enclosure-Interval for Euler Gamma
      friend l_interval EulerGa_l_interval() noexcept(false);  // EulerGamma
      //! Enclosure-Interval for Catalan Numbers
      friend l_interval Catalan_l_interval() noexcept(false);  // Catalan

      // Operatoren: l/real op idotprecision
      //      
      // friend inline void accumulate(idotprecision &, const real &, const l_real &) noexcept(false);
      // friend inline void accumulate(idotprecision &, const l_real &, const real &) noexcept(false);

      // Operatoren: l_real op idotprecision
      //
      // friend inline void accumulate(idotprecision &, const l_real &, const l_real &) noexcept(false);

      // Operatoren: real, l_interval op idotprecision
      //
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const real &, const l_interval &) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const l_interval &, const real &) noexcept(false);

      // Operatoren: interval, l_real op idotprecision
      //
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const interval &, const l_real &) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const l_real &, const interval &) noexcept(false);    

      // Operatoren: l_interval, l_real op idotprecision
      //
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const l_interval &, const l_real &) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const l_real &, const l_interval &) noexcept(false);

      // Operatoren: l_interval, interval op idotprecision
      //
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const l_interval &, const interval &) noexcept(false);
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend inline void accumulate(idotprecision &, const interval &, const l_interval &) noexcept(false);

      // Operatoren: l_interval op idotprecision
      //
      //! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(idotprecision &, const l_interval &, const l_interval &) noexcept(false);
      ...
      friend inline bool zero_(const l_interval& ) noexcept(false); // Blomquist,27.11.02
      //! Multiplication of interval with \f$ 2^n \f$
      friend void times2pown(l_interval&, int) noexcept(false);    // Blomquist,28.11.02
      //! Multiplication of interval with \f$ 2^n \f$
      friend void Times2pown(l_interval&, const real&) noexcept(false);
      friend void l_realz2l_interval(const l_real&, const interval&,
			       l_interval&) noexcept(false); // Blomquist,28.11.02
   ...
   private:
      ...
      inline void _allo(int) noexcept(false);
#endif
      inline void _clear(int) noexcept(false);
      void _akku_out(idotprecision&) noexcept(false);
      void _akku_out_inn(idotprecision&) noexcept(false);
      void _akku_add(idotprecision &) const noexcept(false);
      void _akku_sub(idotprecision &) const noexcept(false);
...
interval _unchecked_interval(const l_real &, const l_real &) noexcept(false);
...
*/
inline l_interval _l_interval(const real & a) noexcept(false) { return l_interval(a); }
/*!
\deprecated use standard contructors for typecasting
...
*/
inline l_interval _l_interval(const l_real & a) noexcept(false) { return l_interval(a); }
/*!
\deprecated use standard contructors for typecasting
...
*/
inline l_interval _l_interval(const interval & a) noexcept(false) { return l_interval(a); }
/*!
\deprecated use standard contructors for typecasting

\sa cxsc::l_interval::l_interval(const dotprecision &)
*/
inline l_interval _l_interval(const dotprecision & a) noexcept(false) { return l_interval(a); }
/*!
\deprecated use standard contructors for typecasting
...
*/
inline l_interval _l_interval(const idotprecision & a) noexcept(false) { return l_interval(a); }
l_interval _unchecked_l_interval(const l_real &, const l_real &) noexcept(false);      
 
//inline l_interval_Inf Inf (l_interval &)  noexcept(false);
//inline l_interval_Sup Sup (l_interval &)  noexcept(false);
inline l_real         Inf (const l_interval &) noexcept(false);
inline l_real         Sup (const l_interval &) noexcept(false);
...
void times2pown(l_interval&, int) noexcept(false);    // Blomquist,28.11.02
void Times2pown(l_interval&, const real&) noexcept(false);
...
class l_interval_Inf
{
   ...
   public:
      // l_interval_Inf(const l_interval_Inf &a) noexcept(false) : my_l_interval(a.my_l_interval) {}
      //! Constructor of class l_interval_Inf
      l_interval_Inf(l_interval &a) noexcept(false) : my_l_interval(a) {}
...
class l_interval_Sup
{
   ...
   public:
      ...
      l_interval_Sup(l_interval &a) noexcept(false) : my_l_interval(a) {}
