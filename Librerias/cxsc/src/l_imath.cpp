...
l_interval sqrt1px2(const l_interval& x) noexcept(false)
...
l_interval sqrtx2y2(const l_interval& x, const l_interval& y) noexcept(false)
...
// l_interval li_ln2() noexcept(false)
l_interval Ln2_l_interval() noexcept(false)
...
// l_interval li_ln10() noexcept(false)
l_interval Ln10_l_interval() noexcept(false)
{
   l_interval y;
   int stagsave = stagprec,
       stagmax = 20;
...
// l_interval li_Rln10() noexcept(false)
l_interval Ln10r_l_interval() noexcept(false)
{
   l_interval y;
   int stagsave = stagprec,
       stagmax = 20;
...
// l_interval li_pi4() noexcept(false)
l_interval Pid4_l_interval() noexcept(false)
{
   l_interval y;
   int stagsave = stagprec,
       stagmax = 20;
...
// l_interval li_sqrt2() noexcept(false)
l_interval Sqrt2_l_interval() noexcept(false)
{
   l_interval y;
   int stagsave = stagprec,
       stagmax = 20;
...
l_interval Sqrt5_l_interval() noexcept(false)
...
l_interval Sqrt7_l_interval() noexcept(false)
...
l_interval Ln2r_l_interval() noexcept(false)
...
l_interval Pi_l_interval() noexcept(false)
...
l_interval Pid2_l_interval() noexcept(false)
...
l_interval Pi2_l_interval() noexcept(false)
...
l_interval Pid3_l_interval() noexcept(false)
...
l_interval Pir_l_interval() noexcept(false)
...
l_interval Pi2r_l_interval() noexcept(false)
...
l_interval SqrtPi_l_interval() noexcept(false)
...
l_interval Sqrt2Pi_l_interval() noexcept(false)
...
l_interval SqrtPir_l_interval() noexcept(false)
...
l_interval Sqrt2Pir_l_interval() noexcept(false)
...
l_interval Pip2_l_interval() noexcept(false)
// Inclusion of Pi^2, Blomquist, 12.09.06;
{
   l_interval y;
   int stagsave = stagprec,
...
l_interval Sqrt2r_l_interval() noexcept(false)
...
l_interval Sqrt3_l_interval() noexcept(false)
...
l_interval Sqrt3d2_l_interval() noexcept(false)
...
l_interval Sqrt3r_l_interval() noexcept(false)
...
l_interval LnPi_l_interval() noexcept(false)
...
l_interval Ln2Pi_l_interval() noexcept(false)
...
l_interval E_l_interval() noexcept(false)
...
l_interval Er_l_interval() noexcept(false)
...
l_interval Ep2_l_interval() noexcept(false)
...
l_interval Ep2r_l_interval() noexcept(false)
...
l_interval EpPi_l_interval() noexcept(false)
...
l_interval Ep2Pi_l_interval() noexcept(false)
...
l_interval EpPid2_l_interval() noexcept(false)
...
l_interval EpPid4_l_interval() noexcept(false)
...
l_interval EulerGa_l_interval() noexcept(false)
...
l_interval Catalan_l_interval() noexcept(false)
...
l_interval atan(const l_interval & x) noexcept(false)  // aTan(x)
{
   int         stagsave = stagprec,
               stagmax = 19,
               digits = 53,
...
l_interval acot(const l_interval &x) noexcept(false)  // ACot(x)
{
...
l_interval expm1(const l_interval & x) noexcept(false)
// exp(x)-1;            
{
    l_interval y(0.0);
...
int cxsc_zweihoch(int) noexcept(false);
...
int cxsc_zweihoch(int n) noexcept(false)
{ 
   // liefert 2^n
...
l_interval tanh(const l_interval & x) noexcept(false)
...
l_interval coth(const l_interval & x) noexcept(false)
...
l_interval acosh(const l_interval & x) noexcept(false)  
...
l_interval lnp1(const l_interval& x) noexcept(false)
...
l_interval ln_sqrtx2y2(const l_interval& x, const l_interval& y) noexcept(false)
