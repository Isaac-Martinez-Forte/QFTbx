...
template <class V,class MV> friend  V &_vmvsetre(V &rv,const MV &v)
  ...
  */
	...
	explicit INLINE imatrix_subv (interval *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept(false):dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class imatrix_subv
	INLINE imatrix_subv(const imatrix_subv &v) noexcept(false):dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:
	...
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const imatrix_subv &rv) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const rmatrix_subv &rv) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix_subv &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	friend INLINE int Lb(const imatrix_subv &rv) noexcept(false) { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const imatrix_subv &rv) noexcept(false) { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const imatrix_subv &rv) noexcept(false) { return rv.size; }
	...
	INLINE imatrix_subv &operator ()() noexcept(false) { return *this; }
	...
	INLINE imatrix_subv &operator *=(const interval &c) noexcept(false);
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_subv &operator *=(const real &c) noexcept(false);
	//! Implementation of addition and allocation operation
	INLINE imatrix_subv &operator +=(const real &c) noexcept(false);
	//! Implementation of subtraction and allocation operation
	INLINE imatrix_subv &operator -=(const real &c) noexcept(false);
...
// interval
	...
	INLINE imatrix(const imatrix &rm) noexcept(false);
	//! Constructor of class imatrix
	INLINE imatrix(const imatrix_slice &rm) noexcept(false);
	//! Constructor of class imatrix
	INLINE imatrix(const simatrix &rm);
	//! Constructor of class imatrix
	INLINE imatrix(const simatrix_slice &rm);
	//! Constructor of class imatrix
	INLINE imatrix() noexcept(false);
	//! Constructor of class imatrix
...
#endif
	//! Constructor of class imatrix
	explicit INLINE imatrix(const ivector &v) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const ivector_slice &v) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const imatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const imatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const simatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const simatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const ivector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const ivector_slice &v) noexcept(false);
//  real
	//! Constructor of class imatrix
	explicit INLINE imatrix(const real &r) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rmatrix &rm) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rmatrix_slice &rm) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const srmatrix &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const srmatrix_slice &rm);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rvector &v) noexcept(false);
	//! Constructor of class imatrix
	explicit INLINE imatrix(const rvector_slice &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rmatrix &m) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rmatrix_slice &ms) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const srmatrix &m);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const srmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rvector &v) noexcept(false);
	//! Implementation of standard assigning operator
	INLINE imatrix &operator =(const rvector_slice &v) noexcept(false);

	//--------------------------- Destruktoren -----------------------------

	INLINE ~imatrix() noexcept(false) { delete [] dat; }
	...
	INLINE imatrix &operator ()() noexcept(false) { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class V,class MS,class S> friend 	 V &_vmslimultassign(V &v,const MS &ms)
  ...
  /*   friend TINLINE l_ivector &_vsmslimultassign<l_ivector_slice,imatrix_slice,l_interval>(l_ivector_slice &v,const imatrix_slice &m)
	...
	explicit INLINE imatrix_slice(imatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class imatrix_slice
	explicit INLINE imatrix_slice(imatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept(false):dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class imatrix_slice
        INLINE imatrix_slice(const imatrix_slice &ms) noexcept(false):dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept(false);
#endif
	friend INLINE imatrix::imatrix(const imatrix_slice &) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE imatrix_slice &operator =(const interval &r) noexcept(false);
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE imatrix_slice &operator =(const real &r) noexcept(false);
	//! Implementation of standard assigning operator
	...
	//! Operator for accessing the whole matrix
	INLINE imatrix_slice &operator ()() noexcept(false) { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE imatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
...
#endif
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_slice &operator *=(const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix_slice &operator *=(const real &c) noexcept(false);
	//! Implementation of division and allocation operation
	INLINE imatrix_slice &operator /=(const interval &c) noexcept(false);
	//! Implementation of division and allocation operation
	INLINE imatrix_slice &operator /=(const real &c) noexcept(false);
...
//=======================Vector / Scalar =========================
	...
	INLINE ivector operator /(const imatrix_subv &rv, const interval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE ivector operator *(const imatrix_subv &rv, const interval &s) noexcept(false);
	//! Implementation of multiplication operation
	INLINE ivector operator *(const interval &s, const imatrix_subv &rv) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE ivector abs(const imatrix_subv &mv) noexcept(false);
	...
	INLINE rvector diam(const imatrix_subv &mv) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE rvector mid(const imatrix_subv &mv) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE rvector Inf(const imatrix_subv &mv) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE rvector Sup(const imatrix_subv &mv) noexcept(false);
...
#endif
	//! Returns the matrix with the new given supremum value
	INLINE imatrix_subv &SetSup(imatrix_subv &iv,const real &r) noexcept(false);
	//! Returns the matrix with the new given infimum value
	INLINE imatrix_subv &SetInf(imatrix_subv &iv,const real &r) noexcept(false);
	//! Returns the matrix with the new unchecked given supremum value
	INLINE imatrix_subv &UncheckedSetSup(imatrix_subv &iv,const real &r) noexcept(false);
	//! Returns the matrix with the new unchecked given infimum value
	INLINE imatrix_subv &SetUncheckedInf(imatrix_subv &iv,const real &r) noexcept(false);
...
//===================== Matrix Functions =============================
	...
	INLINE imatrix _imatrix(const imatrix &rm) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const ivector &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const ivector_slice &v) noexcept(false);
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE imatrix _imatrix(const interval &r) noexcept(false);
...
#endif
	//! Resizes the matrix
	INLINE void Resize(imatrix &A) noexcept(false);
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const imatrix &m) noexcept(false);
	//! Returns the absolute minimum value of the matrix
	INLINE rmatrix absmin(const imatrix &m) noexcept(false);
	//! Returns the absolute maximum value of the matrix
	INLINE rmatrix absmax(const imatrix &m) noexcept(false);
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const imatrix_slice &ms) noexcept(false);
	//! Returns the absolute minimum value of the matrix
	INLINE rmatrix absmin(const imatrix_slice &ms) noexcept(false);
	//! Returns the absolute maximum value of the matrix
	INLINE rmatrix absmax(const imatrix_slice &ms) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE rmatrix diam(const imatrix &m) noexcept(false);
	//! Returns the rounded diameter of the matrix
	INLINE rmatrix diam(const imatrix_slice &ms) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE rmatrix mid(const imatrix &m) noexcept(false);
	//! Returns the rounded middle of the matrix
	INLINE rmatrix mid(const imatrix_slice &ms) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE rmatrix Inf(const imatrix &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE rmatrix Sup(const imatrix &m) noexcept(false);
	//! Returns the infimum of the matrix
	INLINE rmatrix Inf(const imatrix_slice &m) noexcept(false);
	//! Returns the supremum of the matrix
	INLINE rmatrix Sup(const imatrix_slice &m) noexcept(false);
	//! Returns the matrix with the new given infimum value
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix &m,const interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix_slice &ms,const interval &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix &operator *=(imatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix_slice &ms, const interval &c) noexcept(false);
...
//------------ real - imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const real &c, const imatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const real &c, const imatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix &m,const real &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const imatrix_slice &ms,const real &c) noexcept(false);
	//! Implementation of multiplication and allocation operation
	INLINE imatrix &operator *=(imatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix &m,const real &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const imatrix_slice &ms, const real &c) noexcept(false);
...
//----------------- rmatrix - interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const rmatrix &m) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const interval &c, const rmatrix_slice &ms) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const rmatrix &m,const interval &c) noexcept(false);
	//! Implementation of multiplication operation
	INLINE imatrix operator *(const rmatrix_slice &ms,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const rmatrix &m,const interval &c) noexcept(false);
	//! Implementation of division operation
	INLINE imatrix operator /(const rmatrix_slice &ms, const interval &c) noexcept(false);
...
//================ Matrix / Matrix ============================
	...
	INLINE const imatrix &operator +(const imatrix &m1) noexcept(false);
	//! Implementation of positive sign operation
	INLINE imatrix operator +(const imatrix_slice &ms) noexcept(false);
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const imatrix &m1,const imatrix &m2) noexcept(false);
	...
	INLINE bool operator >=(const imatrix &m1,const imatrix &m2) noexcept(false);
	//! Implementation of standard equality operation
	INLINE bool operator ==(const imatrix &m1,const imatrix_slice &ms) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const imatrix &m1,const imatrix_slice &ms) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const imatrix &m1,const imatrix_slice &ms) noexcept(false);
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const imatrix_slice &m1,const imatrix_slice &m2) noexcept(false);
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const imatrix_slice &m1,const imatrix_slice &m2) noexcept(false);
	//! Implementation of standard less-than operation
	INLINE bool operator <(const imatrix_slice &m1,const imatrix_slice &m2) noexcept(false);
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const imatrix &ms) noexcept(false);
	//! Implementation of standard negation operation
	INLINE bool operator !(const imatrix_slice &ms) noexcept(false);

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix &r) noexcept(false);
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix_slice &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,imatrix &r) noexcept(false);
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,imatrix_slice &r) noexcept(false);
