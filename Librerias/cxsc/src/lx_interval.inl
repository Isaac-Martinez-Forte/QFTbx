...
inline lx_interval Blow(const lx_interval& a) noexcept(false)
...
inline lx_interval & lx_interval::operator = (const lx_interval &a) noexcept(false)
{
    ex = a.ex;
    li = a.li;
    return *this;
...
inline lx_interval & lx_interval::operator = (const lx_real &a) noexcept(false)
{
    ex = expo(a);
    li = lr_part(a);
    return *this;
...
inline lx_interval & lx_interval::operator = (const l_interval &a) noexcept(false)
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const l_real & a) noexcept(false)
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const real & a) noexcept(false)
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const interval & a) noexcept(false)
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval operator+(const lx_interval & a) noexcept(false) { return a; }
inline lx_interval operator-(const lx_interval & a) noexcept(false)
{  return lx_interval(a.ex,-a.li);  }

inline lx_interval operator + (const lx_interval &a, const l_interval &b) noexcept(false)
{  return a + lx_interval(b); }

inline lx_interval operator + (const l_interval &a, const lx_interval &b) noexcept(false)
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const l_real &b) noexcept(false)
{  return a + lx_interval(b); }

inline lx_interval operator + (const l_real &a, const lx_interval &b) noexcept(false)
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const lx_real &b) noexcept(false)
{  return a + lx_interval(b); }

inline lx_interval operator + (const lx_real &a, const lx_interval &b) noexcept(false)
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const real &b) noexcept(false)
{  return a + lx_interval(b); }

inline lx_interval operator + (const real &a, const lx_interval &b) noexcept(false)
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const interval &b) noexcept(false)
{  return a + lx_interval(b); }

inline lx_interval operator + (const interval &a, const lx_interval &b) noexcept(false)
{  return lx_interval(a) + b; }

inline lx_interval & operator +=(lx_interval &a, const lx_interval &b) noexcept(false)
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const l_interval &b) noexcept(false)
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const l_real &b) noexcept(false)
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const lx_real &b) noexcept(false)
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const real &b) noexcept(false)
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const interval &b) noexcept(false)
{  return a = a+b; }

inline lx_interval operator - (const lx_interval &a, const lx_interval &b) noexcept(false)
{  return a + lx_interval(-b); }
...
inline bool operator ! (const lx_interval& a) noexcept(false)
{ return !a.li; }

inline bool operator == (const lx_interval &a, const lx_interval &b) noexcept(false)
{
...
inline bool operator == (const lx_interval &a, const l_interval &b) noexcept(false)
{  return (a == lx_interval(b)); }

inline bool operator == (const l_interval &a, const lx_interval &b) noexcept(false)
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const interval &b) noexcept(false)
{  return (a == lx_interval(b)); }

inline bool operator == (const interval &a, const lx_interval &b) noexcept(false)
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const real &b) noexcept(false)
{  return ( a == lx_interval(b)); }

inline bool operator == (const lx_interval &a, const l_real &b) noexcept(false)
{  return ( a == lx_interval(b)); }

inline bool operator == (const real &a, const lx_interval &b) noexcept(false)
{  return ( lx_interval(a) == b); }

inline bool operator == (const l_real &a, const lx_interval &b) noexcept(false)
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const lx_real &b) noexcept(false)
{  return ( a == lx_interval(b)); }

inline bool operator == (const lx_real &a, const lx_interval &b) noexcept(false)
{  return ( lx_interval(a) == b); }
...
inline lx_interval adjust(const lx_interval &a) noexcept(false)
{  return lx_interval(a.ex,adjust(a.li));  }

inline lx_interval abs(const lx_interval &a) noexcept(false)
{  return lx_interval(a.ex,abs(a.li));  }

inline bool point_intv(const lx_interval &a)
{  return point_intv(a.li);  }

inline void times2pown(lx_interval &a, const real& n) noexcept(false)
{  a = lx_interval(add_real(n,a.ex),a.li); }

inline void times2pown_neg(lx_interval& a, const real& n) noexcept(false)
...
inline lx_real Inf(const lx_interval &a) noexcept(false)
{  return lx_real(a.ex,Inf(a.li));  }

inline lx_real Sup(const lx_interval &a) noexcept(false)
...
inline lx_real diam(const lx_interval &a) noexcept(false)
{  return lx_real(a.ex,diam(a.li)); }

inline lx_real mid(const lx_interval& a) noexcept(false)
{  return lx_real(a.ex,mid(a.li)); }

inline bool IsEmpty(const lx_interval& a) noexcept(false)
...
inline lx_interval operator |(const lx_real &a, const lx_real &b) noexcept(false)
{
