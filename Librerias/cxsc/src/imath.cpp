...
interval sqr    (const interval &a) noexcept(false) 
{ 
  interval res;
  res= a*a;
...
interval sqrt1px2(const interval& x) noexcept(false)
...
interval sqrtx2y2(const interval& x, const interval& y) noexcept(false)
...
//********************************************************************
//  Constants for:   interval sqrtp1m1(const interval& x) noexcept(false)
//  Blomquist 05.08.03
...
//********************************************************************
interval sqrtp1m1(const interval& x) noexcept(false)
...
interval lnp1(const interval& x) noexcept(false)
...
interval ln_sqrtx2y2(const interval& x, const interval& y) noexcept(false)
...
inline int round_g(const real& x) noexcept(false) 
