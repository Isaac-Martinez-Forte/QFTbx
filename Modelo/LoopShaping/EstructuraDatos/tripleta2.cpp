...
Tripleta2::Tripleta2(qreal index, LtiSystem * sistema, flags_box flags) : Tripleta (index, sistema, flags) {
    recorteActivado = true;
}

Tripleta2::Tripleta2(qreal index, LtiSystem * sistema,  QVector <data_box *> * datos) : Tripleta(index, sistema, datos) {
    recorteActivado = true;
}
