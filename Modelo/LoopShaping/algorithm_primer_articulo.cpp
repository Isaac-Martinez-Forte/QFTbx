...
inline Sistema * Algorithm_primer_articulo::aceleratedNuevo(Sistema * v, QVector <datos_caja> * datosCortesBoundaries) {
    ...
    for (qint32 i = 0; i < omega->size(); i++) {
        ...
        if (datosCortesBoundaries->at(i).flag == ambiguous) {
            ...
            cortesMinMag = datosCortesBoundaries->at(i).minimosMaximos->at(0);
            cortesMaxMag = datosCortesBoundaries->at(i).minimosMaximos->at(1);
...
inline Sistema * Algorithm_primer_articulo::aceleratedAntiguo(Sistema * v, QVector <datos_caja> * datosCortesBoundaries) {
