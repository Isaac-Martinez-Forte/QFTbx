...
void BoundaryViewer::mostrarDiagrama(){
...
void BoundaryViewer::crearCuadro(QColor color, qint32 pos){
...
void BoundaryViewer::revisarCheckBox(){
...
void BoundaryViewer::on_exportar_clicked()
{
   /* QString fileName = QFileDialog::getSaveFileName(this, tr("Save boundaries"));
...
void BoundaryViewer::on_guardar_clicked()
{
    bool noFallo = true;
    QString extension;
